...
export class Reflector extends Mesh {
	...
	constructor( o = {} ) {
		...
		let geometry = o.geometry !== undefined ? o.geometry : new PlaneGeometry( o.size || 300, o.size || 300, 1, 1 );
		...
		this.material = new MeshStandardMaterial({ name:'ground', color:this.color, map:this.map, roughness:0.2, metalness:1, opacity:this.opacity });
		this.material.transparent = this.opacity !== 1 ? true : false;
...
//Reflector.prototype = Object.assign( Object.create( Mesh.prototype ), {
	...
	groundAlpha () {
		...
		this.material.alphaMap = new Texture( img );
		this.material.transparent = true;
		this.material.depthWrite = false;

		let _this = this;

		img.onload = function(){ _this.material.alphaMap.needsUpdate = true; }
