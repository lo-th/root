...
var shaderHack = ( function () {
    ...
    shaderHack.init = function(){
        ...
        //this.shaderPush('basic', 'vertex', [ "uniform float glowC;", "uniform float glowP;", "varying float intensity;", "varying vec3 v_eyeNormal;" ] );
        ...
        this.shaderPush('basic', 'vertex', ["varying vec3 vNN;","varying vec3 vPP;","varying vec3 vNormal;", "uniform float glowC;", "uniform float glowP;", "varying float intensity;", "varying vec3 v_eyeNormal;" ] );
        ...
        this.shaderMain('basic', 'vertex', vm );

        // FRAGMENT HACK

        //this.shaderRemplace('basic', 'fragment', '#include <metalnessmap_fragment>', 'float metalnessFactor = metalness;');
        ...
        this.shaderPush('basic', 'fragment', fa );
        ...
        "if( cartoon == 1 ){",
           ...
           // "vec3 mapcolor = mapping.rgb * basecolor.rgb; ",
            "vec3 color =  (basecolor.rgb*0.5) + (cdf * basecolor) + (csf * u_specular);",
            //"vec3 color = (cdf * basecolor) + (csf * u_specular);",
...
/*
        ...
        this.shaderMain('basic', 'fragment', fm );

        this.uniformPush('basic', 'cartoon', { type: "i", value: 1  });
        this.uniformPush('basic', 'u_celShading', { type: "f", value: 4 });
        this.uniformPush('basic', 'u_specular', { type: "c", value: new THREE.Color( 0x606060 ) } );
        this.uniformPush('basic', 'u_shine', { type: "f", value: 10 });
        this.uniformPush('basic', 'u_light', { type: "v3", value: new THREE.Vector3( 0, 500, 500 ) });

        this.uniformPush('basic', 'glow', { type: "i", value: 0 });
        this.uniformPush('basic', 'glowC', { type: "f", value: 0.8 });
        this.uniformPush('basic', 'glowP', { type: "f", value: 3 });
        //this.uniformPush('basic', 'glowC', { type: "f", value: 0.8 });
        //this.uniformPush('basic', 'glowP', { type: "f", value: 1.4 });
        this.uniformPush('basic', 'glowColor', { type: "c", value: new THREE.Color( 0xFF0000 ) } );
