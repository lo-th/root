...
THREE.BVHLoader.prototype = {
    ...
    applyToModel: function ( model, clip, tPose, seq , py) {
        ...
        //var oldPosition = new THREE.Vector3().copy( model.position );
       ...
       // var pp = new THREE.Vector3(0,0,0).setFromMatrixPosition( model.matrixWorld );
        ...
        rootMtx.setPosition( new THREE.Vector3(py,0,0) );
        ...
        for( k = 0; k < lngS; k++ ){
            ...
            for ( i = 0; i < lngB; ++ i ) {
                ...
                //if( name === 'root' ){
                    //console.log('root', nodeTracks[i].length, bone.position)

                    //bone.position.set(0,0,0);
                    
                    //bone.position.copy(model.position);
                //}
