...
Object.assign(THREE.SEA3D.Animator.prototype,{update:function(a){this.mixer.update(a||0)},updateAnimations:function(a){this.playing&&this.stop();this.mixer&&THREE.SEA3D.AnimationHandler.removeAnimator(this);THREE.SEA3D.AnimationHandler.addAnimator(this);this.mixer=a;this.playing=this.relative=!1;this.timeScale=1;this.animations=[];this.animationsData={};this.clips=this instanceof THREE.SEA3D.Animator?this.clips:this.geometry.animations;a=0;for(var b=this.clips;a<b.length;a++){var c=b[a].name;this.animations[c]=
this.animations[a]=b[a];this.animationsData[c]=this.animationsData[a]={}}},playw:function(a,b){var c=this.animations[a],d=this.mixer.clipAction(c);this.playing=!0;d.setLoop(c.loop?THREE.LoopRepeat:THREE.LoopOnce,Infinity).reset();d.clampWhenFinished=!c.loop;d.paused=!1;d.setEffectiveWeight(b);return d.play()},crossfade:function(a,b,c){this.mixer.stopAllAction();a=this.playw(a,1);b=this.playw(b,1);a.crossFadeTo(b,c,!1)},warp:function(a,b,c){this.mixer.stopAllAction();a=this.playw(a,1);b=this.playw(b,
1);a.crossFadeTo(b,c,!0)},stopAll:function(){this.mixer.stopAllAction()},unPauseAll:function(){this.mixer.timeScale=1},pauseAll:function(){this.mixer.timeScale=0},setClipTimeScale:function(a,b){this.mixer.clipAction(this.animations[a]).setEffectiveTimeScale(b)},getStateByName:function(a){return this.animations.indexOf(this.animations[a])},getStateNameByIndex:function(a){return this.animations[a].name},pause:function(){this.playing&&this.currentAnimation&&(THREE.SEA3D.AnimationHandler.removeAnimator(this),
this.playing=!1)},resume:function(){!this.playing&&this.currentAnimation&&(THREE.SEA3D.AnimationHandler.addAnimator(this),this.playing=!0);return this},setTimeScale:function(a){this.timeScale=a;this.currentAnimationAction&&this.updateTimeScale()},getTimeScale:function(){return this.timeScale},updateTimeScale:function(){this.currentAnimationAction.setEffectiveTimeScale(this.timeScale*(this.currentAnimation?this.currentAnimation.timeScale:1))},play:function(a,b,c,d){var e=this.animations[a];if(e==this.currentAnimation)return void 0===
c&&e.loop||(this.currentAnimationAction.time=void 0!==c?c:0<=this.currentAnimationAction.timeScale?0:this.currentAnimation.duration),this.currentAnimationAction.setEffectiveWeight(void 0!==d?d:1),this.currentAnimationAction.paused=!1,this.resume();if(!e)throw Error('Animation "'+a+'" not found.');this.previousAnimation=this.currentAnimation;this.currentAnimation=e;this.previousAnimationAction=this.currentAnimationAction;this.currentAnimationAction=this.mixer.clipAction(e).setLoop(e.loop?THREE.LoopRepeat:
THREE.LoopOnce,Infinity).reset();this.currentAnimationAction.clampWhenFinished=!e.loop;this.currentAnimationAction.paused=!1;this.previousAnimationData=this.currentAnimationData;this.currentAnimationData=this.animationsData[a];this.updateTimeScale();void 0===c&&e.loop||(this.currentAnimationAction.time=void 0!==c?c:0<=this.currentAnimationAction.timeScale?0:this.currentAnimation.duration);this.currentAnimationAction.setEffectiveWeight(void 0!==d?d:1);this.currentAnimationAction.play();this.playing||
this.mixer.update(0);this.playing=!0;this.previousAnimation&&this.previousAnimationAction.crossFadeTo(this.currentAnimationAction,b||0,!0);THREE.SEA3D.AnimationHandler.addAnimator(this);return this},stop:function(){this.currentAnimation&&(this.currentAnimationAction.stop(),THREE.SEA3D.AnimationHandler.removeAnimator(this),this.previousAnimation=this.currentAnimation,this.previousAnimationData=this.currentAnimationData,this.previousAnimationAction=this.currentAnimationAction,delete this.currentAnimationAction,
delete this.currentAnimationData,delete this.currentAnimation,this.playing=!1);return this},setRelative:function(a){this.relative!=a&&(this.stop(),this.relative=a)},getRelative:function(){return this.relative}});THREE.SEA3D.Object3DAnimator=function(a,b){this.object3d=b;THREE.SEA3D.Animator.call(this,a,new THREE.AnimationMixer(b))};
...
THREE.SEA3D.Mesh.prototype=Object.assign(Object.create(THREE.Mesh.prototype),THREE.SEA3D.Mesh.prototype,THREE.SEA3D.Object3D.prototype,{constructor:THREE.SEA3D.Mesh,setWeight:function(a,b){this.animations[a]?this.mixer.clipAction(this.animations[a]).setEffectiveWeight(b):this.morphTargetDictionary[a]&&(this.morphTargetInfluences[this.morphTargetDictionary[a]]=b)},getWeight:function(a){if(this.animations[a])return this.mixer.clipAction(a).getEffectiveWeight();if(this.morphTargetDictionary[a])return this.morphTargetInfluences[this.morphTargetDictionary[a]]},
copy:function(a){THREE.Mesh.prototype.copy.call(this,a);this.attribs=a.attribs;this.scripts=a.scripts;this.animator&&(this.animator=a.animator.clone(this));return this}});THREE.SEA3D.SkinnedMesh=function(a,b,c){THREE.SkinnedMesh.call(this,a,b,c);this.updateAnimations(new THREE.AnimationMixer(this))};
