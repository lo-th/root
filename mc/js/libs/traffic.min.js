...
nativeLastIndexOf=ArrayProto.lastIndexOf,nativeIsArray=Array.isArray,nativeKeys=Object.keys,nativeBind=FuncProto.bind,TRAFFIC={TYPE_OF_CARS:[{w:1.8,l:4.8,h:1.4,m:"car001",name:"fordM",wPos:[0.76,0,1.46],wRadius:0.36,nWheels:4},{w:1.8,l:4.5,h:1.8,m:"car002",name:"vaz",wPos:[0.72,0,1.31],wRadius:0.36,nWheels:4},{w:2.2,l:5,h:1.5,m:"car003",name:"coupe",wPos:[0.96,0,1.49],wRadius:0.36,nWheels:4},{w:2.2,l:5.2,h:1.9,m:"car004",name:"c4",wPos:[0.93,0,1.65],wRadius:0.4,nWheels:4},{w:2.2,l:5.2,h:1.8,m:"car005",
name:"ben",wPos:[0.88,0,1.58],wRadius:0.4,nWheels:4},{w:2.1,l:5.4,h:1.7,m:"car006",name:"taxi",wPos:[0.9,0,1.49],wRadius:0.4,nWheels:4},{w:2.2,l:5.4,h:1.9,m:"car007",name:"207",wPos:[0.94,0,1.6],wRadius:0.4,nWheels:4},{w:2.3,l:5.9,h:1.7,m:"car008",name:"police",wPos:[0.96,0,1.67],wRadius:0.4,nWheels:4},{w:2.7,l:6.2,h:2.6,m:"car009",name:"van1",wPos:[1.14,0,1.95],wRadius:0.46,nWheels:4},{w:2.2,l:6.6,h:2.8,m:"car010",name:"van2",wPos:[0.89,0,2.1],wRadius:0.4,nWheels:4},{w:2.8,l:7,h:3.2,m:"car011",name:"van3",
wPos:[0.9,0.26,1.83],wRadius:0.46,nWheels:4},{w:2.8,l:8.9,h:3.9,m:"car012",name:"truck1",wPos:[1,0,2.58,1.23],wRadius:0.57,nWheels:6},{w:3,l:10.6,h:3.4,m:"car013",name:"truck1",wPos:[1.17,0,3.64,2.37],wRadius:0.57,nWheels:6},{w:3,l:12.7,h:3.4,m:"car014",name:"bus",wPos:[1.25,0,2.49],wRadius:0.64,nWheels:4}],settings:{lightsFlipInterval:20,gridSize:32,defaultTimeFactor:5}};TRAFFIC.abs=Math.abs;TRAFFIC.sqrt=Math.sqrt;TRAFFIC.atan2=Math.atan2;TRAFFIC.random=Math.random;TRAFFIC.max=Math.max;
TRAFFIC.min=Math.min;TRAFFIC.PI=Math.PI;TRAFFIC.binding=function(a,b){return function(){return a.apply(b,arguments)}};TRAFFIC.bind=function(a,b){var c,d;if(nativeBind&&a.bind===nativeBind)return nativeBind.apply(a,slice.call(arguments,1));c=slice.call(arguments,2);return d=function(){if(!(this instanceof d))return a.apply(b,c.concat(slice.call(arguments)));ctor.prototype=a.prototype;var e=new ctor;ctor.prototype=null;var f=a.apply(e,c.concat(slice.call(arguments)));return Object(f)===f?f:e}};
