...
import TriangulationPoint from "../entities/TriangulationPoint.js";
import MeshVertex from "../entities/MeshVertex.js";
import { BinSort } from "../utils/BinSort.js";
import { isPointOnRightSideOfLine } from "../utils/MathUtils.js";
...
export class Triangulator {
     ...
     */
    constructor(inputPoints, normal) {
        ...
        if (this.N >= 3) {
            ...
            this.skipTriangle = new Array(this.triangleCount).fill(false)
    ...
    triangulate() {
        ...
        for (let i = 0; i < this.triangleCount; i++) {
            ...
            if (!this.skipTriangle[i]) {
                triangles.push( this.triangulation[i][V1], this.triangulation[i][V2], this.triangulation[i][V3] )
            }
        }
    ...
    normalizeCoordinates() {
        ...
        //this.normalizationScaleFactor = normalizationScaleFactor
    }
     ...
     */
    insertPointIntoTriangle(p, t, triangleCount) {
        //                         V1
        //                         *
        //                        /|\
        //                       /3|2\
     ...
     */
    swapQuadDiagonalIfNeeded(p, t1, t2) {
     ...
     */
    findSharedEdge(tOrigin, tAdjacent) {
