...
import {
    Vector3, Quaternion, Matrix4, Euler, Group
} from 'three';
...
export class Controller extends OrbitControls {
    ...
    constructor( object, domElement, group ) {
    	...
    	this.followGroup = group || new Group();
    ...
    startFollow ( mesh, o ) {
        ...
        cam.stiffness = o.stiffness !== undefined ? o.stiffness : cam.stiffness;
        cam.stiffnessTarget = o.stiffnessTarget !== undefined ? o.stiffnessTarget : cam.stiffnessTarget;

        cam.height = o.height !== undefined ? o.height : cam.height;
        cam.d.set(0,cam.height,0);

        cam.theta = o.theta !== undefined ? o.theta : cam.theta;
        cam.phi = o.phi !== undefined ? o.phi : cam.phi;
        cam.distance = o.distance !== undefined ? o.distance : cam.distance;
        cam.maxDistance = cam.distance;
        cam.rotation = o.rotation !== undefined ? o.rotation : cam.rotation;
