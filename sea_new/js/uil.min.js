...
this.width+"px";this.isCenter&&(this.content.style.marginLeft=-~~(0.5*this.width)+"px");for(var b=a=this.uis.length;b--;)this.uis[b].setSize(this.width);for(b=a;b--;)this.uis[b].rSize();this.resize()}};UIL.Proto=function(a){a=a||{};this.main=a.main||null;this.p=a.p||a.tPercent||0;this.autoWidth=!0;this.isGroup=!1;this.parentGroup=null;this.autoHeight=!1;this.isUI=a.isUI||!1;this.isEdit=this.mono=this.isNumber=!1;if(this.simple=a.simple||!1)this.sa=0;this.width=this.isUI?this.main.width:UIL.WIDTH;void 0!==a.width&&(this.width=a.width);void 0!==a.size&&(this.width=a.size);this.setSize(this.width);void 0!==a.sa&&(this.sa=a.sa);void 0!==a.sb&&(this.sb=a.sb);this.simple&&(this.sb=this.width-this.sa);
this.sc=void 0===a.sc?47:a.sc;this.val=this.parent=null;this.isSend=!1;var b=20;this.isUI&&(b=UIL.HEIGHT);this.h=a.h||a.height||b;this.h=11>this.h?11:this.h;this.bgcolor=UIL.COLOR||a.bgcolor;this.bg=this.isUI?this.main.bg:"rgba(44,44,44,0.3)";void 0!==a.bg&&(this.bg=a.bg);this.titleColor=a.titleColor||UIL.BASECOLOR;this.fontColor=a.fontColor||UIL.BASECOLOR;this.colorPlus=UIL.ColorLuma(this.fontColor,0.3);this.txt=a.name||"Proto";this.rename=a.rename||"";this.target=a.target||null;this.callback=void 0===
a.callback?null:a.callback;this.endCallback=null;null===this.callback&&this.isUI&&null!==this.main.callback&&(this.callback=this.main.callback);this.c=[];this.s=[];this.c[0]=UIL.DOM(null,"div",UIL.BASIC+"position:relative; height:20px; float:left; overflow:hidden;");this.s[0]=this.c[0].style;this.isUI&&(this.s[0].marginBottom="1px");this.simple||(this.c[1]=UIL.DOM(null,"div",UIL.TXT),this.s[1]=this.c[1].style,this.c[1].textContent=""===this.rename?this.txt:this.rename,this.s[1].color=this.titleColor);
...
document.body.removeChild(this.c[0]);this.target=this.callback=this.s=this.c=null},setSize:function(a){this.autoWidth&&(this.width=a,this.p||(this.p=UIL.P),this.simple?this.sb=this.width-this.sa:(a=this.p/100*this.width,this.sa=~~a,this.sb=~~this.width-a-10))},rSize:function(){this.autoWidth&&(this.s[0].width=this.width+"px",this.simple||(this.s[1].width=this.sa+"px"))},setTypeNumber:function(a){this.isNumber=!0;this.value=0;void 0!==a.value&&(this.value="string"===typeof a.value?1*a.value:a.value);
this.min=void 0===a.min?-Infinity:a.min;this.max=void 0===a.max?Infinity:a.max;this.precision=void 0===a.precision?2:a.precision;var b;switch(this.precision){case 0:b=1;break;case 1:b=0.1;break;case 2:b=0.01;break;case 3:b=0.001;break;case 4:b=1E-4}this.step=void 0===a.step?b:a.step;this.range=this.max-this.min;this.value=this.numValue(this.value)},numValue:function(a){return 1*Math.min(this.max,Math.max(this.min,a)).toFixed(this.precision)},addEvent:function(){for(var a=this.c.length,b,c;a--;)if(c=
this.c[a],void 0!==c&&void 0!==c.events)for(b=c.events.length;b--;)c.addEventListener(c.events[b],this,!1)},clearEvent:function(){for(var a=this.c.length,b,c;a--;)if(c=this.c[a],void 0!==c&&void 0!==c.events)for(b=c.events.length;b--;)c.removeEventListener(c.events[b],this,!1)},handleEvent:function(a){},setReferency:function(a,b){this.parent=a;this.val=b},display:function(a){this.s[0].display=a?"block":"none"}};UIL.Group=function(a){UIL.Proto.call(this,a);this.isGroup=this.autoHeight=!0;this.baseH=this.h;var b=Math.floor(0.5*this.h)-6;this.isOpen=a.open||!1;this.c[2]=UIL.DOM(null,"div",UIL.BASIC+"width:100%; left:0; height:auto; overflow:hidden; top:"+this.h+"px");this.c[3]=UIL.DOM(null,"path",UIL.BASIC+"position:absolute; width:10px; height:10px; left:0; top:"+b+"px;",{d:UIL.GPATH,fill:this.fontColor,stroke:"none"});this.c[4]=UIL.DOM(null,"path",UIL.BASIC+"position:absolute; width:10px; height:10px; left:4px; top:"+
