...
SEA3D.Math.lerpAng1x=function(a,b,c){a[0]=SEA3D.Math.lerpAngle(a[0],b[0],c)};SEA3D.Math.lerpColor1x=function(a,b,c){a[0]=SEA3D.Math.lerpColor(a[0],b[0],c)};SEA3D.Math.lerpQuat4x=function(a,b,c){var d=a[0],e=a[1],f=a[2],h=a[3],g=b[0],k=b[1],m=b[2];b=b[3];0>d*g+e*k+f*m+h*b&&(g=-g,k=-k,m=-m,b=-b);d+=c*(g-d);e+=c*(k-e);f+=c*(m-f);c=h+c*(b-h);h=1/Math.sqrt(c*c+d*d+e*e+f*f);a[0]=d*h;a[1]=e*h;a[2]=f*h;a[3]=c*h};SEA3D.Timer=function(){this.time=this.start=Date.now()};
...
b.readAnimationList(c));this.depthWrite=0==(this.attrib&256);this.depthTest=0==(this.attrib&512);this.premultipliedAlpha=0!=(this.attrib&1024);a=b.readUByte();for(var d=0;d<a;++d){var e=b.readUShort(),f=b.readUShort(),h=b.position,g,k;switch(e){case SEA3D.Material.PHONG:g={ambientColor:b.readUInt24(),diffuseColor:b.readUInt24(),specularColor:b.readUInt24(),specular:b.readFloat(),gloss:b.readFloat()};break;case SEA3D.Material.PHYSICAL:g={color:b.readUInt24(),roughness:b.readFloat(),metalness:b.readFloat()};
break;case SEA3D.Material.ANISOTROPIC:break;case SEA3D.Material.COMPOSITE_TEXTURE:g={composite:c.getObject(b.readUInt())};break;case SEA3D.Material.DIFFUSE_MAP:g={texture:c.getObject(b.readUInt())};break;case SEA3D.Material.SPECULAR_MAP:g={texture:c.getObject(b.readUInt())};break;case SEA3D.Material.NORMAL_MAP:g={texture:c.getObject(b.readUInt())};break;case SEA3D.Material.REFLECTION:case SEA3D.Material.FRESNEL_REFLECTION:g={texture:c.getObject(b.readUInt()),alpha:b.readFloat()};e==SEA3D.Material.FRESNEL_REFLECTION&&
(g.power=b.readFloat(),g.normal=b.readFloat());break;case SEA3D.Material.REFRACTION:g={texture:c.getObject(b.readUInt()),alpha:b.readFloat(),ior:b.readFloat()};break;case SEA3D.Material.RIM:g={color:b.readUInt24(),strength:b.readFloat(),power:b.readFloat(),blendMode:b.readBlendMode()};break;case SEA3D.Material.LIGHT_MAP:g={texture:c.getObject(b.readUInt()),channel:b.readUByte(),blendMode:b.readBlendMode()};break;case SEA3D.Material.DETAIL_MAP:g={texture:c.getObject(b.readUInt()),scale:b.readFloat(),
blendMode:b.readBlendMode()};break;case SEA3D.Material.CEL:g={color:b.readUInt24(),levels:b.readUByte(),size:b.readFloat(),specularCutOff:b.readFloat(),smoothness:b.readFloat()};break;case SEA3D.Material.TRANSLUCENT:g={translucency:b.readFloat(),scattering:b.readFloat()};break;case SEA3D.Material.BLEND_NORMAL_MAP:k=b.readUByte();g={texture:c.getObject(b.readUInt()),secondaryTexture:c.getObject(b.readUInt())};k&1?(g.offsetX0=b.readFloat(),g.offsetY0=b.readFloat(),g.offsetX1=b.readFloat(),g.offsetY1=
b.readFloat()):g.offsetX0=g.offsetY0=g.offsetX1=g.offsetY1=0;g.animate=k&2;break;case SEA3D.Material.MIRROR_REFLECTION:g={texture:c.getObject(b.readUInt()),alpha:b.readFloat()};break;case SEA3D.Material.AMBIENT_MAP:g={texture:c.getObject(b.readUInt())};break;case SEA3D.Material.ALPHA_MAP:g={texture:c.getObject(b.readUInt())};break;case SEA3D.Material.EMISSIVE:g={color:b.readUInt24()};break;case SEA3D.Material.EMISSIVE_MAP:g={texture:c.getObject(b.readUInt())};break;case SEA3D.Material.ROUGHNESS_MAP:case SEA3D.Material.METALNESS_MAP:g=
{texture:c.getObject(b.readUInt())};break;case SEA3D.Material.VERTEX_COLOR:g={blendMode:b.readBlendMode()};break;case SEA3D.Material.WRAP_LIGHTING:g={color:b.readUInt24(),strength:b.readFloat()};break;case SEA3D.Material.COLOR_REPLACE:k=b.readUByte();g={red:b.readUInt24(),green:b.readUInt24(),blue:b.readUInt24F()};k&1&&(g.mask=c.getObject(b.readUInt()));k&2&&(g.alpha=b.readFloat());break;case SEA3D.Material.REFLECTION_SPHERICAL:g={texture:c.getObject(b.readUInt()),alpha:b.readFloat()};break;case SEA3D.Material.REFLECTIVITY:k=
b.readUByte();g={strength:b.readFloat()};k&1&&(g.mask=c.getObject(b.readUInt()));break;case SEA3D.Material.CLEAR_COAT:g={strength:b.readFloat(),roughness:b.readFloat()};break;default:console.warn("SEA3D: MaterialTechnique not found:",e.toString(16));b.position=h+f;continue}g.kind=e;this.technique.push(g);this.tecniquesDict[e]=g;b.position=h+f}};SEA3D.Material.PHONG=0;SEA3D.Material.COMPOSITE_TEXTURE=1;SEA3D.Material.DIFFUSE_MAP=2;SEA3D.Material.SPECULAR_MAP=3;SEA3D.Material.REFLECTION=4;
...
4<=b)if(c=(b>>1)-1,f=(2|b&1)<<c,14>b)f+=a.reverseDecode2(this._posDecoders,f-b-1,this._rangeDecoder,c);else{if(f+=this._rangeDecoder.decodeDirectBits(c-4)<<4,f+=this._posAlignDecoder.reverseDecode(this._rangeDecoder),0>f){if(-1===f)break;return!1}}else f=b;if(f>=m||f>=this._dictionarySizeCheck)return!1;this._outWindow.copyBlock(f,l);m+=l;l=this._outWindow.getByte(0)}this._outWindow.flush();this._outWindow.releaseStream();this._rangeDecoder.releaseStream();return!0};a.Decoder.prototype.setDecoderProperties=
...
Object.defineProperties(THREE.SEA3D.Animation.prototype,{name:{get:function(){return this.clip.name}},repeat:{get:function(){return this.clip.repeat}},mixer:{set:function(a){this.mx&&(this.mx.uncacheClip(this.clip),delete this.mx);a&&(this.mx=a,this.mx.clipAction(this.clip))},get:function(){return this.mx}}});THREE.SEA3D.Animator=function(a,b){this.updateAnimations(a,b);this.clone=function(a){return(new this.constructor(this.clips,new THREE.AnimationMixer(a))).copyFrom(this)}.bind(this)};
...
THREE.SEA3D.prototype.updateTransform=function(a,b){var c=THREE.SEA3D.MTXBUF,d=THREE.SEA3D.VECBUF;b.transform?c.fromArray(b.transform):c.makeTranslation(b.position.x,b.position.y,b.position.z);a.position.setFromMatrixPosition(c);a.scale.setFromMatrixScale(c);c.scale(d.set(1/a.scale.x,1/a.scale.y,1/a.scale.z));a.rotation.setFromRotationMatrix(c);if(this.config.forceStatic||b.isStatic)a.updateMatrix(),a.matrixAutoUpdate=!1};
...
THREE.SEA3D.prototype.addDefaultAnimation=function(a,b){for(var c=a.tag,d=0,e=a.animations?a.animations.length:0;d<e;d++){var f=a.animations[d];switch(f.tag.type){case SEA3D.Animation.prototype.type:return d=f.tag.tag||this.getAnimationType({sea:f.tag,scope:c,relative:f.relative}),c.animator=new b(d,c),c.animator.setRelative(f.relative),this.config.autoPlay&&c.animator.play(0),c.animator}}};
...
THREE.SEA3D.prototype.readMesh=function(a){var b,c,d=a.geometry.tag,e,f,h,g,k;b=0;for(c=a.modifiers?a.modifiers.length:0;b<c;b++){var m=a.modifiers[b];switch(m.type){case SEA3D.Skeleton.prototype.type:case SEA3D.SkeletonLocal.prototype.type:f=m;d.bones=f.tag;break;case SEA3D.Morph.prototype.type:k=m,d.morphAttributes=k.tag.attribs,d.morphTargets=k.tag.targets}}b=0;for(c=a.animations?a.animations.length:0;b<c;b++)switch(m=a.animations[b],m.tag.type){case SEA3D.SkeletonAnimation.prototype.type:h=m.tag;
d.animations=h.tag||this.getAnimationType({sea:h,skeleton:f,relative:!0});break;case SEA3D.VertexAnimation.prototype.type:g=m.tag,d.morphAttributes=g.tag.attribs,d.morphTargets=g.tag.targets,d.animations=g.tag.animations}c=void 0!=k||void 0!=g;k=k&&void 0!=k.tag.attribs.normal||g&&void 0!=g.tag.attribs.normal;if(a.material)if(1<a.material.length){e=[];for(b=0;b<a.material.length;b++)e[b]=a.material[b].tag,e[b].morphTargets=c,e[b].morphNormals=k,e[b].vertexColors=a.geometry.color?THREE.VertexColors:
THREE.NoColors;e=new THREE.MultiMaterial(e)}else e=a.material[0].tag,e.morphTargets=c,e.morphNormals=k,e.vertexColors=a.geometry.color?THREE.VertexColors:THREE.NoColors;f?(b=new THREE.SEA3D.SkinnedMesh(d,e,this.config.useVertexTexture),this.config.autoPlay&&h&&b.play(0)):g?(b=new THREE.SEA3D.VertexAnimationMesh(d,e,g.frameRate),this.config.autoPlay&&b.play(0)):b=new THREE.SEA3D.Mesh(d,e);b.name=a.name;b.castShadow=a.castShadows;b.receiveShadow=a.material?a.material[0].receiveShadows:!0;this.domain.meshes=
this.meshes=this.meshes||[];this.meshes.push(this.objects["m3d/"+a.name]=a.tag=b);this.addSceneObject(a);this.updateTransform(b,a);this.addDefaultAnimation(a,THREE.SEA3D.Object3DAnimator)};
...
this.sounds3d||[];this.sounds3d.push(this.objects["sn3d/"+a.name]=a.tag=b);this.addSceneObject(a);this.updateTransform(b,a);this.addDefaultAnimation(a,THREE.SEA3D.SoundAnimator)};
...
THREE.SEA3D.prototype.readMaterial=function(a){var b=this.createMaterial(a);b.name=a.name;b.depthWrite=a.depthWrite;b.depthTest=a.depthTest;b.premultipliedAlpha=a.premultipliedAlpha;b.side=a.bothSides?THREE.DoubleSide:THREE.FrontSide;this.setBlending(b,a.blendMode);for(var c=0;c<a.technique.length;c++){var d=a.technique[c];this.materialTechnique[d.kind]&&this.materialTechnique[d.kind].call(this,b,d,a)}this.materialTechnique.onComplete&&this.materialTechnique.onComplete.call(this,b,a);this.domain.materials=
this.materials=this.materials||[];this.materials.push(this.objects["mat/"+a.name]=a.tag=b)};
...
a);this.addDefaultAnimation(a,THREE.SEA3D.CameraAnimator)};THREE.SEA3D.prototype.readSkeletonLocal=function(a){for(var b=[],c=0;c<a.joint.length;c++){var d=a.joint[c];b[c]={name:d.name,pos:[d.x,d.y,d.z],rotq:[d.qx,d.qy,d.qz,d.qw],parent:d.parentIndex}}a.tag=b};THREE.SEA3D.prototype.readJointObject=function(a){var b=a.target.tag.skeleton.bones[a.joint];this.domain.joints=this.joints=this.joints||[];this.joints.push(this.objects["jnt/"+a.name]=a.tag=b)};
...
THREE.SEA3D.prototype.readAnimation=function(a){for(var b=[],c=1E3/a.frameRate/1E3,d=0;d<a.sequence.length;d++){for(var e=a.sequence[d],f=[],h=0;h<a.dataList.length;h++){var g=a.dataList[h],k,m,l,s=g.data;l=e.start*g.blockSize;k=l+e.count*g.blockSize;var r=e.intrpl?THREE.InterpolateLinear:!1,q=null;switch(g.kind){case SEA3D.Animation.POSITION:q=".position";break;case SEA3D.Animation.ROTATION:q=".quaternion";break;case SEA3D.Animation.SCALE:q=".scale";break;case SEA3D.Animation.COLOR:q=".color";break;
case SEA3D.Animation.MULTIPLIER:q=".intensity";break;case SEA3D.Animation.FOV:q=".fov"}if(q)switch(g.type){case SEA3D.Stream.BYTE:case SEA3D.Stream.UBYTE:case SEA3D.Stream.INT:case SEA3D.Stream.UINT:case SEA3D.Stream.FLOAT:case SEA3D.Stream.DOUBLE:case SEA3D.Stream.DECIMAL:l=s.subarray(l,k);m=new Float32Array(l.length);for(k=g=0;k<m.length;k++)m[k]=g,g+=c;f.push(new THREE.VectorKeyframeTrack(q,m,l,r));break;case SEA3D.Stream.VECTOR3D:l=s.subarray(l,k);m=new Float32Array(l.length/g.blockSize);for(k=
g=0;k<m.length;k++)m[k]=g,g+=c;f.push(new THREE.VectorKeyframeTrack(q,m,l,r));break;case SEA3D.Stream.VECTOR4D:l=s.subarray(l,k);m=new Float32Array(l.length/g.blockSize);for(k=g=0;k<m.length;k++)m[k]=g,g+=c;f.push(new THREE.QuaternionKeyframeTrack(q,m,l,r));break;case SEA3D.Stream.INT24:case SEA3D.Stream.UINT24:l=new Float32Array(3*(k-l));m=new Float32Array(l.length/3);for(k=g=0;k<m.length;k++)l[3*k]=(s[k]>>16&255)/255,l[3*k+1]=(s[k]>>8&255)/255,l[3*k+2]=(s[k]&255)/255,m[k]=g,g+=c;f.push(new THREE.VectorKeyframeTrack(q,
m,l,r))}}b.push(new THREE.SEA3D.AnimationClip(e.name,-1,f,e.repeat))}this.domain.clips=this.clips=this.clips||[];this.clips.push(this.objects[a.name+".anm"]=a.tag=b)};
THREE.SEA3D.prototype.readSkeletonAnimation=function(a,b){for(var c=[],d=1E3/a.frameRate/1E3,e=0;e<a.sequence.length;e++){for(var f=a.sequence[e],h=f.start,g=h+f.count,k={name:f.name,fps:a.frameRate,length:d*f.count,hierarchy:[]},m=a.numJoints,l=a.raw,s=0;s<m;s++){for(var r={parent:b.joint[s].parentIndex,keys:[]},q=r.keys,t=0,p=h;p<g;p++){var n=p*m*7+7*s;q.push({time:t,pos:[l[n],l[n+1],l[n+2]],rot:[l[n+3],l[n+4],l[n+5],l[n+6]],scl:[1,1,1]});t+=d}k.hierarchy[s]=r}c.push(THREE.SEA3D.AnimationClip.fromClip(THREE.AnimationClip.parseAnimation(k,
b.tag),f.repeat))}this.domain.clips=this.clips=this.clips||[];this.clips.push(this.objects[a.name+".skla"]=a.tag=c)};
THREE.SEA3D.prototype.readVertexAnimation=function(a){var b={position:[]},c=[],d=[],e,f;e=0;for(f=a.frame.length;e<f;e++){var h=a.frame[e];b.position[e]=new THREE.Float32BufferAttribute(h.vertex,3);h.normal&&(b.normal=b.normal||[],b.normal[e]=new THREE.Float32BufferAttribute(h.normal,3));c[e]={name:e}}for(e=0;e<a.sequence.length;e++){var h=a.sequence[e],g=[];for(f=0;f<h.count;f++)g[f]=c[h.start+f];d.push(THREE.SEA3D.AnimationClip.fromClip(THREE.AnimationClip.CreateFromMorphTargetSequence(h.name,g,
a.frameRate),h.repeat))}a.tag={attribs:b,targets:c,animations:d};this.domain.clips=this.clips=this.clips||[];this.clips.push(this.objects[a.name+".vtxa"]=a.tag)};THREE.SEA3D.prototype.getAnimationType=function(a){var b=a.sea;switch(b.type){case SEA3D.SkeletonAnimation.prototype.type:this.readSkeletonAnimation(b,a.skeleton)}return b.tag};
...
function(a){this.config.manager&&this.config.manager.add(this.domain);this.onComplete.call(this,a)}.bind(this);this.createDomain();this.setTypeRead();void 0!==a&&("string"===typeof a?this.file.load(a):this.file.read(a))};Object.assign(THREE.SEA3D.prototype,{_onHead:THREE.SEA3D.prototype.onHead,_updateTransform:THREE.SEA3D.prototype.updateTransform,_readVertexAnimation:THREE.SEA3D.prototype.readVertexAnimation,_readGeometryBuffer:THREE.SEA3D.prototype.readGeometryBuffer,_readLine:THREE.SEA3D.prototype.readLine,_getAnimationType:THREE.SEA3D.prototype.getAnimationType,_readAnimation:THREE.SEA3D.prototype.readAnimation});
THREE.SEA3D.prototype.isLegacy=function(a){var b=a.sea3d;return"S3D"!=b.sign||a._legacy?!1:(a._legacy=!0==b.typeUnique[a.type],b.config.legacy)};THREE.SEA3D.prototype.flipVec3=function(a){if(a){for(var b=2;b<a.length;)a[b]=-a[b],b+=3;return a}};
...
THREE.SEA3D.prototype.flipScaleMatrix=function(){var a=new THREE.Vector3,b=new THREE.Quaternion,c=new THREE.Vector3;return function(d,e,f,h){f&&d.multiplyMatrices(f,d);d.decompose(a,b,c);c.z=-c.z;d.compose(a,b,c);e&&d.multiplyMatrices(d,THREE.SEA3D.MTXBUF.makeRotationZ(THREE.Math.degToRad(180)));f&&(f=f.clone(),this.flipScaleMatrix(f,h),d.multiplyMatrices(f.getInverse(f),d));return d}}();
THREE.SEA3D.prototype.flipDefaultAnimation=function(){var a=new THREE.Matrix4,b=new THREE.Matrix4,c=new THREE.Vector3,d=new THREE.Quaternion,e=new THREE.Vector3,f=new THREE.Vector3,h=new THREE.Quaternion,g=new THREE.Vector3;return function(k,m,l){if(!k.isFliped){for(var s=k.dataList,r=[],q=0;q<s.length;q++){var t=s[q],p=t.data,n=t.kind,t=p.length/t.blockSize;switch(n){case SEA3D.Animation.POSITION:case SEA3D.Animation.ROTATION:case SEA3D.Animation.SCALE:r.push({kind:n,numFrames:t,raw:p})}}if(0<r.length)for(t=
r[0].numFrames,p=void 0,l?(a.identity(),this.flipScaleMatrix(b.copy(m.matrixWorld))):(m.parent&&(p=this.flipScaleMatrix(b.copy(m.parent.matrixWorld))),this.flipScaleMatrix(a.copy(m.matrix),!1,p)),a.decompose(c,d,e),m=0;m<t;m++){for(l=0;l<r.length;l++)switch(p=r[l].raw,n=r[l].kind,n){case SEA3D.Animation.POSITION:n=3*m;c.set(p[n],p[n+1],p[n+2]);break;case SEA3D.Animation.ROTATION:n=4*m;d.set(p[n],p[n+1],p[n+2],p[n+3]);break;case SEA3D.Animation.SCALE:n=4*m,e.set(p[n],p[n+1],p[n+2])}a.compose(c,d,e);
this.flipScaleMatrix(a,!1,b);a.decompose(f,h,g);for(l=0;l<r.length;l++)switch(p=r[l].raw,n=r[l].kind,n){case SEA3D.Animation.POSITION:n=3*m;p[n]=f.x;p[n+1]=f.y;p[n+2]=f.z;break;case SEA3D.Animation.ROTATION:n=4*m;p[n]=h.x;p[n+1]=h.y;p[n+2]=h.z;p[n+3]=h.w;break;case SEA3D.Animation.SCALE:n=3*m,p[n]=g.x,p[n+1]=g.y,p[n+2]=g.z}}k.isFliped=!0}}}();THREE.SEA3D.prototype.readAnimation=function(a){this.isLegacy(a)||this._readAnimation(a)};
THREE.SEA3D.prototype.getAnimationType=function(a){var b=a.sea;if(this.isLegacy(b))switch(b.type){case SEA3D.SkeletonAnimation.prototype.type:return this.readSkeletonAnimationLegacy(b,a.skeleton),b.tag;case SEA3D.Animation.prototype.type:return a.scope instanceof THREE.Object3D&&this.flipDefaultAnimation(b,a.scope,a.relative),this._readAnimation(b),b.tag}return this._getAnimationType(a)};
...
THREE.SEA3D.prototype.readSkeleton=function(){var a=new THREE.Matrix4,b=new THREE.Matrix4,c=new THREE.Matrix4,d=new THREE.Vector3,e=new THREE.Quaternion;return function(f){for(var h=[],g=f.sea3d.config.legacy,k=0;k<f.joint.length;k++){var m=f.joint[k];a.elements=m.inverseBindMatrix;b.getInverse(a);g&&this.flipBoneMatrix(b);-1<m.parentIndex&&(a.elements=f.joint[m.parentIndex].inverseBindMatrix,c.getInverse(a),g&&this.flipBoneMatrix(c),c.getInverse(c),b.multiplyMatrices(c,b));d.setFromMatrixPosition(b);
e.setFromRotationMatrix(b);h[k]={name:m.name,pos:[d.x,d.y,d.z],rotq:[e.x,e.y,e.z,e.w],parent:m.parentIndex}}return f.tag=h}}();
THREE.SEA3D.prototype.readSkeletonAnimationLegacy=function(){var a=new THREE.Matrix4,b=new THREE.Matrix4,c=new THREE.Matrix4,d=new THREE.Matrix4;return function(e,f){if(e.tag)return e.tag;for(var h=[],g=1E3/e.frameRate/1E3,k=[1,1,1],m=0;m<e.sequence.length;m++){for(var l=e.sequence[m],s=l.start,r=s+l.count,q={name:l.name,repeat:l.repeat,fps:e.frameRate,JIT:0,length:g*l.count,hierarchy:[]},t=e.numJoints,p=e.raw,n=0;n<t;n++){for(var w=f.joint[n],z={parent:w.parentIndex,keys:[]},A=z.keys,x=0,y=s;y<r;y++){var u=
y*t*7+7*n;b.makeRotationFromQuaternion(THREE.SEA3D.QUABUF.set(p[u+3],p[u+4],p[u+5],p[u+6]));b.setPosition(THREE.SEA3D.VECBUF.set(p[u],p[u+1],p[u+2]));-1<w.parentIndex?(a.elements=f.joint[w.parentIndex].inverseBindMatrix,d.getInverse(a),c.multiplyMatrices(d,b),this.flipBoneMatrix(c),this.flipBoneMatrix(d),d.getInverse(d),b.multiplyMatrices(d,c)):this.flipBoneMatrix(b);var u=THREE.SEA3D.VECBUF.setFromMatrixPosition(b),v=THREE.SEA3D.QUABUF.setFromRotationMatrix(b);A.push({time:x,pos:[u.x,u.y,u.z],rot:[v.x,
v.y,v.z,v.w],scl:k});x+=g}q.hierarchy[n]=z}h.push(THREE.SEA3D.AnimationClip.fromClip(THREE.AnimationClip.parseAnimation(q,f.tag),l.repeat))}this.domain.clips=this.clips=this.clips||[];this.clips.push(this.objects[e.name+".anm"]=e.tag=h)}}();THREE.SEA3D.prototype.readVertexAnimation=function(a){if(this.isLegacy(a))for(var b=0,c=a.frame.length;b<c;b++){var d=a.frame[b];this.flipVec3(d.vertex);this.flipVec3(d.normal)}this._readVertexAnimation(a)};
