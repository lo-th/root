...
Object.assign(THREE.SEA3D.Animator.prototype,{update:function(a){this.mixer.update(a||0)},updateAnimations:function(a){this.playing&&this.stop();this.mixer&&THREE.SEA3D.AnimationHandler.removeAnimator(this);THREE.SEA3D.AnimationHandler.addAnimator(this);this.mixer=a;this.playing=this.relative=!1;this.timeScale=1;this.animations={};this.clips=this instanceof THREE.SEA3D.Animator?this.clips:this.geometry.animations;a=0;for(var b=this.clips;a<b.length;a++)this.addAnimation(b[a])},addAnimation:function(a){this.animations[a.name]=
a;this.mixer.clipAction(a)},playw:function(a,b){var c=this.animations[a],d=this.mixer.clipAction(a);this.playing=!0;d.setLoop(c.loop?THREE.LoopRepeat:THREE.LoopOnce,Infinity).reset();d.clampWhenFinished=!c.loop;d.paused=!1;d.setEffectiveWeight(b);return d.play()},crossfade:function(a,b,c){this.mixer.stopAllAction();a=this.playw(a,1);b=this.playw(b,1);a.crossFadeTo(b,c,!1)},warp:function(a,b,c){this.mixer.stopAllAction();a=this.playw(a,1);b=this.playw(b,1);a.crossFadeTo(b,c,!0)},stopAll:function(){this.mixer.stopAllAction()},
unPauseAll:function(){this.mixer.timeScale=1},pauseAll:function(){this.mixer.timeScale=0},setClipTimeScale:function(a,b){this.mixer.clipAction(this.animations[a]).setEffectiveTimeScale(b)},pause:function(){this.playing&&this.currentAnimation&&(THREE.SEA3D.AnimationHandler.removeAnimator(this),this.playing=!1)},resume:function(){!this.playing&&this.currentAnimation&&(THREE.SEA3D.AnimationHandler.addAnimator(this),this.playing=!0);return this},setTimeScale:function(a){this.timeScale=a;this.currentAnimationAction&&
this.updateTimeScale()},getTimeScale:function(){return this.timeScale},updateTimeScale:function(){this.currentAnimationAction.setEffectiveTimeScale(this.timeScale*(this.currentAnimation?this.currentAnimation.timeScale:1))},play:function(a,b,c,d){var e=this.animations[a];if(e==this.currentAnimation)return void 0===c&&e.loop||(this.currentAnimationAction.time=void 0!==c?c:0<=this.currentAnimationAction.timeScale?0:this.currentAnimation.duration),this.currentAnimationAction.setEffectiveWeight(void 0!==
d?d:1),this.currentAnimationAction.paused=!1,this.resume();if(!e)throw Error('Animation "'+a+'" not found.');this.previousAnimation=this.currentAnimation;this.currentAnimation=e;this.previousAnimationAction=this.currentAnimationAction;this.currentAnimationAction=this.mixer.clipAction(e).setLoop(e.loop?THREE.LoopRepeat:THREE.LoopOnce,Infinity).reset();this.currentAnimationAction.clampWhenFinished=!e.loop;this.currentAnimationAction.paused=!1;this.previousAnimationData=this.currentAnimationData;this.currentAnimationData=
