...
SEA3D.Stream.prototype.readTags=function(a){for(var b=this.readUByte(),c=0;c<b;++c){var d=this.readUShort(),e=this.readUInt(),f=this.position;a(d,this.data,e);this.position=f+e}};SEA3D.Stream.prototype.readProperties=function(a){var b=this.readUByte(),c={},d={};c.__type=d;for(var e=0;e<b;e++){var f=this.readUTF8(),h=this.readUByte();c[f]=this.readToken(h,a);d[f]=h}return c};
...
SEA3D.Stream.prototype.readScriptList=function(a){for(var b=[],c=this.readUByte(),d=0;d<c;){var e=this.readUByte(),f={};f.priority=e&1|e&2;if(e&4){var h=this.readUByte();f.params={};for(var g=0;g<h;g++){var k=this.readUTF8();f.params[k]=this.readObject(a)}}e&8&&(f.method=this.readUTF8());f.tag=a.getObject(this.readUInt());b[d++]=f}return b};SEA3D.Stream.prototype.readObject=function(a){return this.readToken(this.readUByte(),a)};
...
SEA3D.Math.lerpAng1x=function(a,b,c){a[0]=SEA3D.Math.lerpAngle(a[0],b[0],c)};SEA3D.Math.lerpColor1x=function(a,b,c){a[0]=SEA3D.Math.lerpColor(a[0],b[0],c)};SEA3D.Math.lerpQuat4x=function(a,b,c){var d=a[0],e=a[1],f=a[2],h=a[3],g=b[0],k=b[1],l=b[2];b=b[3];0>d*g+e*k+f*l+h*b&&(g=-g,k=-k,l=-l,b=-b);d+=c*(g-d);e+=c*(k-e);f+=c*(l-f);c=h+c*(b-h);h=1/Math.sqrt(c*c+d*d+e*e+f*f);a[0]=d*h;a[1]=e*h;a[2]=f*h;a[3]=c*h};SEA3D.Timer=function(){this.time=this.start=Date.now()};
SEA3D.Timer.prototype={constructor:SEA3D.Timer,get now(){return Date.now()},get deltaTime(){return Date.now()-this.time},get elapsedTime(){return Date.now()-this.start},update:function(){this.time=Date.now()}};SEA3D.Domain=function(a){this.id=a;this.scripts=[];this.global={};this.events=new SEA3D.EventDispatcher};
...
SEA3D.GeometryDeltaBase=function(a,b,c){this.name=a;this.data=b;this.sea3d=c;this.attrib=b.readUShort();this.numVertex=b.readUInteger();this.length=3*this.numVertex;this.attrib&1?(b.readNumber=b.readByte,this.numDiv=127.5):(b.readNumber=b.readShort,this.numDiv=32767.5)};
...
b.readNumber()/this.numDiv*d;var h=b.readUByte();this.indexes=f=[];this.groups=[];for(a=c=0;a<h;a++)for(e=3*b.readVInt(),this.groups.push({start:c,count:e}),e+=c;c<e;)f[c++]=b.readVInt();h=b.readUByte();this.indexes=f=[];this.groups=[];if(this.attrib&2)for(a=0;a<h;a++){e=b.readUInteger();d=f.length;for(c=0;c<e;c++){var g=b.readUInteger(),k=b.readUInteger(),l=b.readUInteger(),m=b.readUInteger();f.push(g);f.push(k);f.push(l);0<m&&(f.push(l),f.push(m+1),f.push(g))}this.groups.push({start:d,count:f.length-
d})}else for(a=c=0;a<h;a++)for(e=3*b.readUInteger(),this.groups.push({start:c,count:e}),e+=c;c<e;)f[c++]=b.readUInteger()};SEA3D.GeometryDeltaBase.prototype=Object.create(SEA3D.GeometryDeltaBase.prototype);SEA3D.GeometryDeltaBase.prototype.constructor=SEA3D.GeometryDelta;SEA3D.GeometryDelta.prototype.type="geDL";
...
c.getObject(b.readUInt());g.target=c.getObject(b.readUInt());break;case SEA3D.Actions.LOOK_AT:g.source=c.getObject(b.readUInt());g.target=c.getObject(b.readUInt());break;case SEA3D.Actions.PLAY_SOUND:g.sound=c.getObject(b.readUInt());g.offset=b.readUInt();break;case SEA3D.Actions.PLAY_ANIMATION:g.object=c.getObject(b.readUInt());g.name=b.readUTF8();break;case SEA3D.Actions.FOG:g.color=b.readUInt24();g.min=b.readFloat();g.max=b.readFloat();break;case SEA3D.Actions.ENVIRONMENT:g.texture=c.getObject(b.readUInt());
break;case SEA3D.Actions.ENVIRONMENT_COLOR:g.color=b.readUInt24F();break;case SEA3D.Actions.CAMERA:g.camera=c.getObject(b.readUInt());break;case SEA3D.Actions.SCRIPTS:g.scripts=b.readScriptList(c);break;case SEA3D.Actions.CLASS_OF:g.classof=c.getObject(b.readUInt());break;default:console.log('Action "'+e+'" not found.')}b.position=h+f}};SEA3D.Actions.SCENE=0;SEA3D.Actions.ENVIRONMENT_COLOR=1;SEA3D.Actions.ENVIRONMENT=2;SEA3D.Actions.FOG=3;SEA3D.Actions.PLAY_ANIMATION=4;SEA3D.Actions.PLAY_SOUND=5;
...
SEA3D.Morph=function(a,b,c){SEA3D.GeometryBase.call(this,a,b,c);a=0!=(this.attrib&2);c=0!=(this.attrib&4);var d=b.readUShort();this.node=[];for(var e=0;e<d;e++){var f=b.readUTF8(),h,g;a&&(h=b.readFloatArray(this.length));c&&(g=b.readFloatArray(this.length));this.node[e]={vertex:h,normal:g,name:f}}};SEA3D.Morph.prototype=Object.create(SEA3D.GeometryBase.prototype);SEA3D.Morph.prototype.constructor=SEA3D.Morph;SEA3D.Morph.prototype.type="mph";
...
SEA3D.Material=function(a,b,c){this.name=a;this.data=b;this.sea3d=c;this.technique=[];this.attrib=b.readUShort();this.alpha=1;this.blendMode="normal";this.alphaThreshold=0.5;this.anisotropy=this.physical=!1;this.bothSides=0!=(this.attrib&1);this.receiveLights=0==(this.attrib&2);this.receiveShadows=0==(this.attrib&4);this.receiveFog=0==(this.attrib&8);this.smooth=0==(this.attrib&16);this.attrib&32&&(this.alpha=b.readFloat());this.attrib&64&&(this.blendMode=b.readBlendMode());this.attrib&128&&(this.animations=
...
SEA3D.File=function(a){this.config={streaming:!0,timeLimit:60};a&&(void 0!==a.streaming&&(this.config.streaming=a.streaming),void 0!==a.timeLimit&&(this.config.timeLimit=a.timeLimit));this.version=SEA3D.VERSION;this.objects=[];this.typeClass={};this.typeRead={};this.typeUnique={};this.position=this.dataPosition=0;this.scope=this;this.addClass(SEA3D.FileInfo,!0);this.addClass(SEA3D.Geometry,!0);this.addClass(SEA3D.GeometryDelta,!0);this.addClass(SEA3D.Mesh);this.addClass(SEA3D.Sprite);this.addClass(SEA3D.Material);
this.addClass(SEA3D.Composite);this.addClass(SEA3D.PointLight);this.addClass(SEA3D.DirectionalLight);this.addClass(SEA3D.HemisphereLight);this.addClass(SEA3D.AmbientLight);this.addClass(SEA3D.Skeleton,!0);this.addClass(SEA3D.SkeletonLocal,!0);this.addClass(SEA3D.SkeletonAnimation,!0);this.addClass(SEA3D.JointObject);this.addClass(SEA3D.Camera);this.addClass(SEA3D.Morph,!0);this.addClass(SEA3D.VertexAnimation,!0);this.addClass(SEA3D.CubeMap,!0);this.addClass(SEA3D.Animation);this.addClass(SEA3D.Dummy);
this.addClass(SEA3D.Line);this.addClass(SEA3D.SoundPoint);this.addClass(SEA3D.PlanarRender);this.addClass(SEA3D.CubeRender);this.addClass(SEA3D.Actions);this.addClass(SEA3D.Container3D);this.addClass(SEA3D.Properties);this.addClass(SEA3D.TextureURL,!0);this.addClass(SEA3D.Sphere);this.addClass(SEA3D.Box);this.addClass(SEA3D.Cone);this.addClass(SEA3D.Capsule);this.addClass(SEA3D.Cylinder);this.addClass(SEA3D.ConvexGeometry);this.addClass(SEA3D.TriangleGeometry);this.addClass(SEA3D.Compound);this.addClass(SEA3D.RigidBody);
this.addClass(SEA3D.P2PConstraint);this.addClass(SEA3D.HingeConstraint);this.addClass(SEA3D.ConeTwistConstraint);this.addClass(SEA3D.CarController);this.addClass(SEA3D.JPEG,!0);this.addClass(SEA3D.JPEG_XR,!0);this.addClass(SEA3D.PNG,!0);this.addClass(SEA3D.GIF,!0);this.addClass(SEA3D.OGG,!0);this.addClass(SEA3D.MP3,!0);this.addClass(SEA3D.JavaScript,!0);this.addClass(SEA3D.JavaScriptMethod,!0);this.addClass(SEA3D.GLSL,!0)};SEA3D.File.CompressionLibs={};SEA3D.File.DecompressionMethod={};
...
SEA3D.File.prototype.readSEAObject=function(){if(4>this.stream.bytesAvailable)return null;var a=this.stream.readUInt(),b=this.stream.position;if(this.stream.bytesAvailable<a)return null;var c=this.stream.readUByte(),d=this.stream.readExt(),e=null,f=c&1?this.stream.readUTF8():"",h=0!=(c&2),g=0!=(c&4);c&8&&(e=this.stream.readUShort(),c=this.stream.concat(this.stream.position,e),this.stream.position+=e,h&&this.decompressionMethod&&(c.buffer=this.decompressionMethod(c.buffer)),e=c.readProperties(this));
a-=this.stream.position-b;b=this.stream.position;c=this.stream.concat(b,a);this.typeClass[d]?(h&&this.decompressionMethod&&(c.buffer=this.decompressionMethod(c.buffer)),h=new this.typeClass[d](f,c,this),this.config.streaming&&g&&this.typeRead[d]&&this.typeRead[d].call(this.scope,h)):(h=new SEA3D.Object(f,c,d,this),console.warn('SEA3D: Unknown format "'+d+'" of file "'+f+'". Add a module referring for this format.'));h.streaming=g;h.metadata=e;this.objects.push(this.objects[h.type+"/"+h.name]=h);this.dataPosition=
b+a;++this.position;return h};SEA3D.File.prototype.isDone=function(){return this.position==this.length};SEA3D.File.prototype.readBody=function(){for(this.timer.update();this.position<this.length;)if(this.timer.deltaTime<this.config.timeLimit){this.stream.position=this.dataPosition;var a=this.readSEAObject();if(a)this.dispatchCompleteObject(a);else return!1}else return!1;this.state=this.readComplete;return!0};
SEA3D.File.prototype.parse=function(){this.timer=new SEA3D.Timer;this.position=0;isFinite(this.config.timeLimit)?setTimeout(this.parseObject.bind(this),10):this.parseObject()};
...
LZMA.Decoder.prototype.decode=function(a,b,c){var d=0,e=0,f=0,h=0,g=0,k=0,l=0;this._rangeDecoder.setStream(a);this._outWindow.setStream(b);for(this.init();0>c||k<c;)if(a=k&this._posStateMask,0===this._rangeDecoder.decodeBit(this._isMatchDecoders,(d<<4)+a))l=this._literalDecoder.getDecoder(k++,l),l=7<=d?l.decodeWithMatchByte(this._rangeDecoder,this._outWindow.getByte(e)):l.decodeNormal(this._rangeDecoder),this._outWindow.putByte(l),d=4>d?0:d-(10>d?3:6);else{if(1===this._rangeDecoder.decodeBit(this._isRepDecoders,
d))l=0,0===this._rangeDecoder.decodeBit(this._isRepG0Decoders,d)?0===this._rangeDecoder.decodeBit(this._isRep0LongDecoders,(d<<4)+a)&&(d=7>d?9:11,l=1):(0===this._rangeDecoder.decodeBit(this._isRepG1Decoders,d)?b=f:(0===this._rangeDecoder.decodeBit(this._isRepG2Decoders,d)?b=h:(b=g,g=h),h=f),f=e,e=b),0===l&&(l=2+this._repLenDecoder.decode(this._rangeDecoder,a),d=7>d?8:11);else if(g=h,h=f,f=e,l=2+this._lenDecoder.decode(this._rangeDecoder,a),d=7>d?7:10,a=this._posSlotDecoder[5>=l?l-2:3].decode(this._rangeDecoder),
...
THREE.SEA3D.Animator=function(a){this.clips=a;this.isPlaying=!1;this.updateAnimations()};THREE.SEA3D.Animator.prototype.updateAnimations=function(){this.animations=[];for(var a=this.clips,b=0;b<a.length;b++)this.animations[b]=a[b],this.animations[a[b].name]=a[b]};THREE.SEA3D.Animator.prototype.getStateByName=function(a){return this.animations.indexOf(this.animations[a])};THREE.SEA3D.Animator.prototype.getStateNameByIndex=function(a){return this.animations[a].name};
THREE.SEA3D.Object3DAnimator=function(a,b){THREE.SEA3D.Animator.call(this,a);this.object3d=b;this.mixer=new THREE.AnimationMixer(b);this.relative=!1};THREE.SEA3D.Object3DAnimator.prototype=Object.create(THREE.SEA3D.Animator.prototype);THREE.SEA3D.Object3DAnimator.prototype.constructor=THREE.SEA3D.Object3DAnimator;THREE.SEA3D.Object3DAnimator.prototype.pause=function(){this.isPlaying&&this.currentAnimation&&(THREE.SEA3D.AnimationHandler.removeMixer(this.mixer),this.isPlaying=!1)};
THREE.SEA3D.Object3DAnimator.prototype.resume=function(){!this.isPlaying&&this.currentAnimation&&(THREE.SEA3D.AnimationHandler.addMixer(this.mixer),this.isPlaying=!0)};THREE.SEA3D.Object3DAnimator.prototype.setTimeScale=function(a){this.mixer._timeScale=a;this.mixer.timeScale=a*(this.currentAnimation?this.currentAnimation.timeScale:1)};THREE.SEA3D.Object3DAnimator.prototype.getTimeScale=function(){return this.mixer._timeScale};
THREE.SEA3D.Object3DAnimator.prototype.play=function(a,b,c){c=this.animations[a];if(!c)throw Error('Animation "'+a+'" not found.');this.previousAnimation=this.currentAnimation;this.currentAnimation=c;this.previousAnimationAction=this.currentAnimationAction;this.currentAnimationAction=this.mixer.clipAction(c).setLoop(c.loop?THREE.LoopRepeat:THREE.LoopOnce,Infinity).reset().play();this.mixer.timeScale=this.mixer._timeScale*this.currentAnimation.timeScale;this.isPlaying||this.mixer.update(0);this.isPlaying=
!0;this.previousAnimation&&this.mixer.clipAction(this.previousAnimation).crossFadeTo(this.mixer.clipAction(this.currentAnimation),b||0,!0);THREE.SEA3D.AnimationHandler.addMixer(this.mixer)};
THREE.SEA3D.Object3DAnimator.prototype.stop=function(){if(this.currentAnimation){if(this instanceof THREE.SEA3D.Object3DAnimator){var a=this.object3d.animate;a.position=new THREE.Vector3;a.quaternion=new THREE.Quaternion;a.scale=new THREE.Vector3(1,1,1)}this.currentAnimationAction.stop();THREE.SEA3D.AnimationHandler.removeMixer(this.mixer);this.previousAnimation=this.currentAnimation;this.previousAnimationAction=this.currentAnimationAction;delete this.currentAnimationAction;delete this.currentAnimation;
this.isPlaying=!1}};THREE.SEA3D.Object3DAnimator.prototype.updateAnimations=function(){this.mixer&&THREE.SEA3D.AnimationHandler.removeMixer(this.mixer);this.mixer=new THREE.AnimationMixer(this);this.animations=[];for(var a=this instanceof THREE.SEA3D.Object3DAnimator?this.clips:this.geometry.animations,b=0;b<a.length;b++)this.animations[b]=a[b],this.animations[a[b].name]=a[b];this.setTimeScale(1)};
THREE.SEA3D.Object3DAnimator.prototype.setRelative=function(a){this.relative!=a&&(this.stop(),this.relative=a,this.object3d.setAnimate(this.relative),this.mixer=new THREE.AnimationMixer(this.relative?this.object3d.animate:this.object3d))};THREE.SEA3D.Object3DAnimator.prototype.getRelative=function(){return this.relative};THREE.SEA3D.CameraAnimator=function(a,b){THREE.SEA3D.Object3DAnimator.call(this,a,b)};THREE.SEA3D.CameraAnimator.prototype=Object.create(THREE.SEA3D.Object3DAnimator.prototype);
THREE.SEA3D.CameraAnimator.prototype.constructor=THREE.SEA3D.CameraAnimator;THREE.SEA3D.LightAnimator=function(a,b){THREE.SEA3D.Object3DAnimator.call(this,a,b)};THREE.SEA3D.LightAnimator.prototype=Object.create(THREE.SEA3D.Object3DAnimator.prototype);THREE.SEA3D.LightAnimator.prototype.constructor=THREE.SEA3D.LightAnimator;THREE.SEA3D.Object3D=function(){THREE.Object3D.call(this)};THREE.SEA3D.Object3D.prototype=Object.create(THREE.Object3D.prototype);THREE.SEA3D.Object3D.prototype.constructor=THREE.SEA3D.Object3D;
THREE.SEA3D.Object3D.prototype.updateAnimateMatrix=function(a){!0===this.matrixAutoUpdate&&this.updateMatrix();if(!0===this.matrixWorldNeedsUpdate||!0===a)null===this.parent?this.matrixWorld.copy(this.matrix):this.matrixWorld.multiplyMatrices(this.parent.matrixWorld,this.matrix),this.animate.updateMatrix(),this.matrixWorld.multiplyMatrices(this.matrixWorld,this.animate.matrix),this.matrixWorldNeedsUpdate=!1,a=!0;for(var b=0,c=this.children.length;b<c;b++)this.children[b].updateMatrixWorld(a)};
THREE.SEA3D.Object3D.prototype.setAnimate=function(a){this.getAnimate()!=a&&(a?(this.animate=new THREE.Object3D,this.updateMatrixWorld=THREE.SEA3D.Object3D.prototype.updateAnimateMatrix):(delete this.animate,this.updateMatrixWorld=THREE.Object3D.prototype.updateMatrixWorld),this.matrixWorldNeedsUpdate=!0)};THREE.SEA3D.Object3D.prototype.getAnimate=function(){return void 0!=this.animate};
THREE.SEA3D.Dummy=function(a,b,c){this.width=void 0!=a?a:100;this.height=void 0!=b?b:100;this.depth=void 0!=c?c:100;a=new THREE.BoxGeometry(this.width,this.height,this.depth,1,1,1);THREE.Mesh.call(this,a,THREE.SEA3D.Dummy.MATERIAL)};THREE.SEA3D.Dummy.prototype=Object.create(THREE.Mesh.prototype);THREE.SEA3D.Dummy.prototype.constructor=THREE.SEA3D.Dummy;THREE.SEA3D.Dummy.prototype.setAnimate=THREE.SEA3D.Object3D.prototype.setAnimate;THREE.SEA3D.Dummy.prototype.getAnimate=THREE.SEA3D.Object3D.prototype.getAnimate;
THREE.SEA3D.Dummy.MATERIAL=new THREE.MeshBasicMaterial({wireframe:!0,color:THREE.SEA3D.HELPER_COLOR});THREE.SEA3D.Dummy.prototype.copy=function(a){THREE.Mesh.prototype.copy.call(this,a);this.props=a.props;this.scripts=a.scripts;this.animation&&(this.animation=a.animation.clone(this));return this};THREE.SEA3D.Dummy.prototype.dispose=function(){this.geometry.dispose()};THREE.SEA3D.Mesh=function(a,b){THREE.Mesh.call(this,a,b)};THREE.SEA3D.Mesh.prototype=Object.create(THREE.Mesh.prototype);
THREE.SEA3D.Mesh.prototype.constructor=THREE.SEA3D.Mesh;THREE.SEA3D.Mesh.prototype.setAnimate=THREE.SEA3D.Object3D.prototype.setAnimate;THREE.SEA3D.Mesh.prototype.getAnimate=THREE.SEA3D.Object3D.prototype.getAnimate;THREE.SEA3D.Mesh.prototype.setWeight=function(a,b){this.morphTargetInfluences[this.morphTargetDictionary[a]]=b};THREE.SEA3D.Mesh.prototype.getWeight=function(a){return this.morphTargetInfluences[this.morphTargetDictionary[a]]};
THREE.SEA3D.Mesh.prototype.copy=function(a){THREE.Mesh.prototype.copy.call(this,a);this.props=a.props;this.scripts=a.scripts;this.animation&&(this.animation=a.animation.clone(this));return this};THREE.SEA3D.SkinnedMesh=function(a,b,c){THREE.SkinnedMesh.call(this,a,b,c);this.isPlaying=!1;this.updateAnimations()};THREE.SEA3D.SkinnedMesh.prototype=Object.create(THREE.SkinnedMesh.prototype);THREE.SEA3D.SkinnedMesh.prototype.constructor=THREE.SEA3D.SkinnedMesh;
THREE.SEA3D.SkinnedMesh.prototype.setAnimate=THREE.SEA3D.Object3D.prototype.setAnimate;THREE.SEA3D.SkinnedMesh.prototype.getAnimate=THREE.SEA3D.Object3D.prototype.getAnimate;THREE.SEA3D.SkinnedMesh.prototype.setTimeScale=THREE.SEA3D.Object3DAnimator.prototype.setTimeScale;THREE.SEA3D.SkinnedMesh.prototype.getTimeScale=THREE.SEA3D.Object3DAnimator.prototype.getTimeScale;THREE.SEA3D.SkinnedMesh.prototype.play=THREE.SEA3D.Object3DAnimator.prototype.play;THREE.SEA3D.SkinnedMesh.prototype.stop=THREE.SEA3D.Object3DAnimator.prototype.stop;
THREE.SEA3D.SkinnedMesh.prototype.pause=THREE.SEA3D.Object3DAnimator.prototype.pause;THREE.SEA3D.SkinnedMesh.prototype.resume=THREE.SEA3D.Object3DAnimator.prototype.resume;THREE.SEA3D.SkinnedMesh.prototype.updateAnimations=THREE.SEA3D.Object3DAnimator.prototype.updateAnimations;THREE.SEA3D.SkinnedMesh.prototype.boneByName=function(a){for(var b=this.skeleton.bones,c=0,d=b.length;c<d;c++)if(a==b[c].name)return b[c];return null};
THREE.SEA3D.SkinnedMesh.prototype.copy=function(a){THREE.SkinnedMesh.prototype.copy.call(this,a);this.props=a.props;this.scripts=a.scripts;this.animation&&(this.animation=a.animation.clone(this));this.geometry.animations&&this.updateAnimations();return this};THREE.SEA3D.SkinnedMesh.prototype.setWeight=function(a,b){this.morphTargetInfluences[this.morphTargetDictionary[a]]=b};THREE.SEA3D.SkinnedMesh.prototype.getWeight=function(a){return this.morphTargetInfluences[this.morphTargetDictionary[a]]};
THREE.SEA3D.VertexAnimationMesh=function(a,b){THREE.Mesh.call(this,a,b);this.type="MorphAnimMesh";this.mixer=new THREE.AnimationMixer(this);this.updateAnimations()};THREE.SEA3D.VertexAnimationMesh.prototype=Object.create(THREE.Mesh.prototype);THREE.SEA3D.VertexAnimationMesh.prototype.constructor=THREE.SEA3D.VertexAnimationMesh;THREE.SEA3D.VertexAnimationMesh.prototype.setAnimate=THREE.SEA3D.Object3D.prototype.setAnimate;THREE.SEA3D.VertexAnimationMesh.prototype.getAnimate=THREE.SEA3D.Object3D.prototype.getAnimate;
THREE.SEA3D.VertexAnimationMesh.prototype.setTimeScale=THREE.SEA3D.Object3DAnimator.prototype.setTimeScale;THREE.SEA3D.VertexAnimationMesh.prototype.getTimeScale=THREE.SEA3D.Object3DAnimator.prototype.getTimeScale;THREE.SEA3D.VertexAnimationMesh.prototype.play=THREE.SEA3D.Object3DAnimator.prototype.play;THREE.SEA3D.VertexAnimationMesh.prototype.stop=THREE.SEA3D.Object3DAnimator.prototype.stop;THREE.SEA3D.VertexAnimationMesh.prototype.pause=THREE.SEA3D.Object3DAnimator.prototype.pause;
THREE.SEA3D.VertexAnimationMesh.prototype.resume=THREE.SEA3D.Object3DAnimator.prototype.resume;THREE.SEA3D.VertexAnimationMesh.prototype.updateAnimations=THREE.SEA3D.Object3DAnimator.prototype.updateAnimations;THREE.SEA3D.VertexAnimationMesh.prototype.copy=function(a){THREE.Mesh.prototype.copy.call(this,a);this.props=a.props;this.scripts=a.scripts;this.animation&&(this.animation=a.animation.clone(this));return this};THREE.SEA3D.Camera=function(a,b,c,d){THREE.PerspectiveCamera.call(this,a,b,c,d)};
THREE.SEA3D.Camera.prototype=Object.create(THREE.PerspectiveCamera.prototype);THREE.SEA3D.Camera.prototype.constructor=THREE.SEA3D.Camera;THREE.SEA3D.Camera.prototype.setAnimate=THREE.SEA3D.Object3D.prototype.setAnimate;THREE.SEA3D.Camera.prototype.getAnimate=THREE.SEA3D.Object3D.prototype.getAnimate;THREE.SEA3D.Camera.prototype.setTimeScale=THREE.SEA3D.Object3DAnimator.prototype.setTimeScale;THREE.SEA3D.Camera.prototype.getTimeScale=THREE.SEA3D.Object3DAnimator.prototype.getTimeScale;
THREE.SEA3D.Camera.prototype.play=THREE.SEA3D.Object3DAnimator.prototype.play;THREE.SEA3D.Camera.prototype.stop=THREE.SEA3D.Object3DAnimator.prototype.stop;THREE.SEA3D.Camera.prototype.pause=THREE.SEA3D.Object3DAnimator.prototype.pause;THREE.SEA3D.Camera.prototype.resume=THREE.SEA3D.Object3DAnimator.prototype.resume;THREE.SEA3D.Camera.prototype.updateAnimations=THREE.SEA3D.Object3DAnimator.prototype.updateAnimations;
THREE.SEA3D.Camera.prototype.copy=function(a){THREE.PerspectiveCamera.prototype.copy.call(this,a);this.props=a.props;this.scripts=a.scripts;this.animation&&(this.animation=a.animation.clone(this));return this};THREE.SEA3D.PointLight=function(a,b,c,d){THREE.PointLight.call(this,a,b,c,d)};THREE.SEA3D.PointLight.prototype=Object.create(THREE.PointLight.prototype);THREE.SEA3D.PointLight.prototype.constructor=THREE.SEA3D.PointLight;THREE.SEA3D.PointLight.prototype.setAnimate=THREE.SEA3D.Object3D.prototype.setAnimate;
THREE.SEA3D.PointLight.prototype.getAnimate=THREE.SEA3D.Object3D.prototype.getAnimate;THREE.SEA3D.PointLight.prototype.setTimeScale=THREE.SEA3D.Object3DAnimator.prototype.setTimeScale;THREE.SEA3D.PointLight.prototype.getTimeScale=THREE.SEA3D.Object3DAnimator.prototype.getTimeScale;THREE.SEA3D.PointLight.prototype.play=THREE.SEA3D.Object3DAnimator.prototype.play;THREE.SEA3D.PointLight.prototype.stop=THREE.SEA3D.Object3DAnimator.prototype.stop;THREE.SEA3D.PointLight.prototype.pause=THREE.SEA3D.Object3DAnimator.prototype.pause;
THREE.SEA3D.PointLight.prototype.resume=THREE.SEA3D.Object3DAnimator.prototype.resume;THREE.SEA3D.PointLight.prototype.updateAnimations=THREE.SEA3D.Object3DAnimator.prototype.updateAnimations;THREE.SEA3D.PointLight.prototype.copy=function(a){THREE.PointLight.prototype.copy.call(this,a);this.props=a.props;this.scripts=a.scripts;this.animation&&(this.animation=a.animation.clone(this));return this};
THREE.SEA3D.AnimationHandler={mixers:[],update:function(a){for(var b=0;b<this.mixers.length;)this.mixers[b++].update(a)},addMixer:function(a){-1===this.mixers.indexOf(a)&&this.mixers.push(a)},removeMixer:function(a){-1!==this.mixers.indexOf(a)&&this.mixers.splice(this.mixers.indexOf(a),1)}};THREE.SEA3D.SCRIPT=new SEA3D.ScriptManager;THREE.SEA3D.SCRIPT.dispatchUpdate=function(a){this.dispatchEvent({type:"update",delta:a})};
THREE.SEA3D.Domain=function(a,b,c){SEA3D.Domain.call(this,a);this.objects=b;this.container=c};THREE.SEA3D.Domain.prototype=Object.create(SEA3D.Domain.prototype);THREE.SEA3D.Domain.prototype.constructor=THREE.SEA3D.Domain;THREE.SEA3D.Domain.prototype.runScripts=function(){for(var a=0;a<this.scriptTargets.length;a++)this.runJSMList(this.scriptTargets[a])};THREE.SEA3D.Domain.prototype.runJSMList=function(a){for(var b=a.scripts,c=0;c<b.length;c++)this.runJSM(a,b[c]);return b};
THREE.SEA3D.Domain.prototype.runJSM=function(a,b){void 0==a.local&&(a.local={});var c={print:this.print,watch:this.watch,sea3d:this,scene:this.container,source:new SEA3D.Script(this,a instanceof THREE.SEA3D.Domain)};Object.freeze(c.source);THREE.SEA3D.SCRIPT.add(c.source);try{this.methods[b.method](c,this.getReference,this.global,a.local,a,b.params)}catch(d){console.error('SEA3D JavaScript: Error running method "'+b.method+'".'),console.error(d)}};
THREE.SEA3D.Domain.prototype.disposeList=function(a){if(a&&a.length){a=a.concat();for(var b=a.length;b--;)a[b].dispose()}};THREE.SEA3D.Domain.prototype.dispose=function(){for(SEA3D.Domain.prototype.dispose.call(this);this.container.children.length;)this.container.remove(this.container.children[0]);for(var a=THREE.SEA3D.EXTENSIONS_DOMAIN.length;a--;){var b=THREE.SEA3D.EXTENSIONS_DOMAIN[a];b.dispose&&b.dispose.call(this)}this.disposeList(this.materials);this.disposeList(this.dummys)};
THREE.SEA3D.DomainManager=function(a){SEA3D.DomainManager.call(this,a)};THREE.SEA3D.DomainManager.prototype=Object.create(SEA3D.DomainManager.prototype);THREE.SEA3D.DomainManager.prototype.constructor=THREE.SEA3D.DomainManager;THREE.SEA3D.DomainManager.prototype.add=function(a){SEA3D.DomainManager.prototype.add.call(this,a);this.textures=this.textures||a.textures;this.cubemaps=this.cubemaps||a.cubemaps;this.geometries=this.geometries||a.geometries};
THREE.SEA3D.DomainManager.prototype.disposeList=THREE.SEA3D.Domain.prototype.disposeList;THREE.SEA3D.DomainManager.prototype.dispose=function(){SEA3D.DomainManager.prototype.dispose.call(this);this.disposeList(this.textures);this.disposeList(this.cubemaps);this.disposeList(this.geometries)};THREE.SEA3D.MTXBUF=new THREE.Matrix4;THREE.SEA3D.VECBUF=new THREE.Vector3;THREE.SEA3D.QUABUF=new THREE.Quaternion;
THREE.SEA3D.prototype.setShadowMap=function(a){a.shadow.mapSize.width=a.shadow.mapSize.height=2048;a.castShadow=!0};SEA3D.Domain.prototype.getMesh=THREE.SEA3D.prototype.getMesh=function(a){return this.objects["m3d/"+a]};SEA3D.Domain.prototype.getDummy=THREE.SEA3D.prototype.getDummy=function(a){return this.objects["dmy/"+a]};SEA3D.Domain.prototype.getLine=THREE.SEA3D.prototype.getLine=function(a){return this.objects["line/"+a]};
SEA3D.Domain.prototype.getSound3D=THREE.SEA3D.prototype.getSound3D=function(a){return this.objects["sn3d/"+a]};SEA3D.Domain.prototype.getMaterial=THREE.SEA3D.prototype.getMaterial=function(a){return this.objects["mat/"+a]};SEA3D.Domain.prototype.getLight=THREE.SEA3D.prototype.getLight=function(a){return this.objects["lht/"+a]};SEA3D.Domain.prototype.getGLSL=THREE.SEA3D.prototype.getGLSL=function(a){return this.objects["glsl/"+a]};
SEA3D.Domain.prototype.getCamera=THREE.SEA3D.prototype.getCamera=function(a){return this.objects["cam/"+a]};SEA3D.Domain.prototype.getTexture=THREE.SEA3D.prototype.getTexture=function(a){return this.objects["tex/"+a]};SEA3D.Domain.prototype.getCubeMap=THREE.SEA3D.prototype.getCubeMap=function(a){return this.objects["cmap/"+a]};SEA3D.Domain.prototype.getJointObject=THREE.SEA3D.prototype.getJointObject=function(a){return this.objects["jnt/"+a]};
SEA3D.Domain.prototype.getContainer3D=THREE.SEA3D.prototype.getContainer3D=function(a){return this.objects["c3d/"+a]};SEA3D.Domain.prototype.getSprite=THREE.SEA3D.prototype.getSprite=function(a){return this.objects["m2d/"+a]};SEA3D.Domain.prototype.getProperties=THREE.SEA3D.prototype.getProperties=function(a){return this.objects["prop/"+a]};THREE.SEA3D.prototype.isPowerOfTwo=function(a){return a?(a&-a)==a:!1};
THREE.SEA3D.prototype.nearestPowerOfTwo=function(a){return Math.pow(2,Math.round(Math.log(a)/Math.LN2))};
...
THREE.SEA3D.prototype.toVector3=function(a){return new THREE.Vector3(a.x,a.y,a.z)};THREE.SEA3D.prototype.scaleColor=function(a,b){return((a>>16)*b&255)<<16|((a>>8&255)*b&255)<<8|(a&255)*b&255};THREE.SEA3D.prototype.updateScene=function(){if(void 0!=this.materials)for(var a=0,b=this.materials.length;a<b;++a)this.materials[a].needsUpdate=!0};
...
THREE.SEA3D.prototype.bufferToTexture=function(a){return this.createObjectURL(a,"image")};THREE.SEA3D.prototype.bufferToSound=function(a){return this.createObjectURL(a,"audio")};
THREE.SEA3D.prototype.applyDefaultAnimation=function(a,b){for(var c=a.tag,d=0,e=a.animations?a.animations.length:0;d<e;d++){var f=a.animations[d];switch(f.tag.type){case SEA3D.Animation.prototype.type:return c.animation=new b(f.tag.tag,c),c.animation.setRelative(f.relative),this.config.autoPlay&&c.animation.play(c.animation.getStateNameByIndex(0)),c.animation}}};
THREE.SEA3D.prototype.readAnimation=function(a){for(var b=[],c=1E3/a.frameRate/1E3,d=0;d<a.sequence.length;d++)for(var e=a.sequence[d],f=[],h=0;h<a.dataList.length;h++){var g=a.dataList[h],k,l=g.data,m=e.start*g.blockSize;k=m+e.count*g.blockSize;var s=e.intrpl?THREE.InterpolateLinear:!1,p=null;switch(g.kind){case SEA3D.Animation.POSITION:p=".position";break;case SEA3D.Animation.ROTATION:p=".quaternion";break;case SEA3D.Animation.SCALE:p=".scale";break;case SEA3D.Animation.COLOR:p=".color";break;case SEA3D.Animation.MULTIPLIER:p=
".intensity";break;case SEA3D.Animation.FOV:p=".fov"}if(p){switch(g.type){case SEA3D.Stream.BYTE:case SEA3D.Stream.UBYTE:case SEA3D.Stream.INT:case SEA3D.Stream.UINT:case SEA3D.Stream.FLOAT:case SEA3D.Stream.DOUBLE:case SEA3D.Stream.DECIMAL:m=l.slice(m,k);k=new Float32Array(m.length);for(var q=g=0;q<k.length;q++)k[q]=g,g+=c;f.push(new THREE.VectorKeyframeTrack(p,k,m,s));break;case SEA3D.Stream.VECTOR3D:m=l.slice(m,k);k=new Float32Array(m.length/g.blockSize);for(q=g=0;q<k.length;q++)k[q]=g,g+=c;f.push(new THREE.VectorKeyframeTrack(p,
k,m,s));break;case SEA3D.Stream.VECTOR4D:m=l.slice(m,k);k=new Float32Array(m.length/g.blockSize);for(q=g=0;q<k.length;q++)k[q]=g,g+=c;f.push(new THREE.QuaternionKeyframeTrack(p,k,m,s));break;case SEA3D.Stream.INT24:case SEA3D.Stream.UINT24:m=new Float32Array(3*(k-m));k=new Float32Array(m.length/3);for(q=g=0;q<k.length;q++)m[3*q]=(l[q]>>16&255)/255,m[3*q+1]=(l[q]>>8&255)/255,m[3*q+2]=(l[q]&255)/255,k[q]=g,g+=c;f.push(new THREE.VectorKeyframeTrack(p,k,m,s))}l=new THREE.AnimationClip(e.name,-1,f);l.loop=
e.repeat;l.timeScale=1;b.push(l)}}this.domain.animationClips=this.animationClips=this.animationClips||[];this.animationClips.push(this.objects[a.name+".#anm"]=a.tag=b)};
...
THREE.SEA3D.prototype.readSprite=function(a){var b;a.material&&(a.material.tag.sprite?b=a.material.tag.sprite:(b=a.material.tag.sprite=new THREE.SpriteMaterial,b.map=a.material.tag.map,b.map.flipY=!0,b.color=a.material.tag.emissive,b.opacity=a.material.tag.opacity,b.blending=a.material.tag.blending));b=new THREE.Sprite(b);b.name=a.name;this.domain.sprites=this.sprites=this.sprites||[];this.sprites.push(this.objects["m2d/"+a.name]=a.tag=b);this.addSceneObject(a);this.updateTransform(b,a);b.scale.set(a.width,
a.height,1)};
THREE.SEA3D.prototype.readMesh=function(a){var b,c,d=a.geometry.tag,e,f,h,g,k;b=0;for(c=a.modifiers?a.modifiers.length:0;b<c;b++){var l=a.modifiers[b];switch(l.type){case SEA3D.Skeleton.prototype.type:case SEA3D.SkeletonLocal.prototype.type:f=l;d.bones=f.tag;break;case SEA3D.Morph.prototype.type:k=l,d.morphAttributes=k.tag.attribs,d.morphTargets=k.tag.targets}}b=0;for(c=a.animations?a.animations.length:0;b<c;b++)switch(l=a.animations[b],l.tag.type){case SEA3D.SkeletonAnimation.prototype.type:h=l.tag;
d.animations=this.getSkeletonAnimation(h,f);break;case SEA3D.VertexAnimation.prototype.type:g=l.tag,d.morphAttributes=g.tag.attribs,d.morphTargets=g.tag.targets,d.animations=g.tag.animations}c=void 0!=k||void 0!=g;k=k&&void 0!=k.tag.attribs.normal||g&&void 0!=g.tag.attribs.normal;if(a.material)if(1<a.material.length){e=[];for(b=0;b<a.material.length;b++)e[b]=a.material[b].tag,e[b].skinning=void 0!=f,e[b].morphTargets=c,e[b].morphNormals=k,e[b].vertexColors=a.geometry.color?THREE.VertexColors:THREE.NoColors;
e=new THREE.MultiMaterial(e)}else e=a.material[0].tag,e.skinning=void 0!=f,e.morphTargets=c,e.morphNormals=k,e.vertexColors=a.geometry.color?THREE.VertexColors:THREE.NoColors;f?(b=new THREE.SEA3D.SkinnedMesh(d,e,this.config.useVertexTexture),this.config.autoPlay&&h&&b.play(b.animations[0].name)):g?(b=new THREE.SEA3D.VertexAnimationMesh(d,e,g.frameRate),this.config.autoPlay&&b.play(b.animations[0].name)):b=new THREE.SEA3D.Mesh(d,e);b.name=a.name;b.castShadow=a.castShadows;b.receiveShadow=a.material?
a.material[0].receiveShadows:!0;this.domain.meshes=this.meshes=this.meshes||[];this.meshes.push(this.objects["m3d/"+a.name]=a.tag=b);this.addSceneObject(a);this.updateTransform(b,a);this.applyDefaultAnimation(a,THREE.SEA3D.Object3DAnimator)};
...
THREE.SEA3D.prototype.readImage=function(a){var b=new Image,c=new THREE.Texture;c.name=a.name;c.wrapS=c.wrapT=THREE.RepeatWrapping;c.flipY=!1;c.image=b;b.onload=function(){c.needsUpdate=!0};b.src=this.bufferToTexture(a.data.buffer);this.domain.textures=this.textures=this.textures||[];this.textures.push(this.objects["tex/"+a.name]=a.tag=c)};
THREE.SEA3D.prototype.readCubeMap=function(a){var b=[],c=new THREE.CubeTexture,d=[];d[0]=a.faces[1];d[1]=a.faces[0];d[2]=a.faces[3];d[3]=a.faces[2];d[4]=a.faces[5];d[5]=a.faces[4];b.loadedCount=0;c.name=a.name;c.image=b;c.flipY=!1;for(var e=0,f=d.length;e<f;++e){var h=new Image;b[e]=h;h.onload=function(){6==++b.loadedCount&&(c.needsUpdate=!0)};h.src=this.bufferToTexture(d[e].buffer)}this.domain.cubemaps=this.cubemaps=this.cubemaps||[];this.cubemaps.push(this.objects["cmap/"+a.name]=a.tag=c)};
THREE.SEA3D.prototype.readSound=function(a){var b=this.bufferToSound(a.data.buffer);this.domain.sounds=this.sounds=this.sounds||[];this.sounds.push(this.objects["snd/"+a.name]=a.tag=b)};THREE.SEA3D.prototype.readTextureURL=function(a){var b=(new THREE.TextureLoader).load(a.url);b.name=a.name;b.wrapS=b.wrapT=THREE.RepeatWrapping;b.flipY=!1;this.domain.textures=this.textures=this.textures||[];this.textures.push(this.objects["tex/"+a.name]=a.tag=b)};
...
THREE.SEA3D.prototype.materialTechnique=function(){var a={onComplete:function(a,c){if(1>c.alpha||a.blending>THREE.NormalBlending)a.opacity=c.alpha,a.transparent=!0}};a[SEA3D.Material.PHYSICAL]=function(a,c){a.color.setHex(c.color);a.roughness=c.roughness;a.metalness=c.metalness};a[SEA3D.Material.PHONG]=function(a,c){a.color.setHex(c.diffuseColor);a.specular.setHex(this.scaleColor(c.specularColor,c.specular));a.shininess=c.gloss};a[SEA3D.Material.DIFFUSE_MAP]=function(a,c,d){a.map=c.texture.tag;a.color.setHex(16777215);
c.texture.transparent&&(a.transparent=!0,a.alphaTest=d.alphaThreshold)};a[SEA3D.Material.ROUGHNESS_MAP]=function(a,c){a.roughnessMap=c.texture.tag};a[SEA3D.Material.METALNESS_MAP]=function(a,c){a.metalnessMap=c.texture.tag};a[SEA3D.Material.SPECULAR_MAP]=function(a,c){a.specularMap=c.texture.tag;a.specular.setHex(16777215)};a[SEA3D.Material.NORMAL_MAP]=function(a,c){a.normalMap=c.texture.tag};a[SEA3D.Material.REFLECTION]=a[SEA3D.Material.FRESNEL_REFLECTION]=function(a,c){a.envMap=c.texture.tag;a.envMap.mapping=
...
a.lightMap=c.texture.tag};return a}();THREE.SEA3D.prototype.createMaterial=function(a){return a.physical?new THREE.MeshStandardMaterial:new THREE.MeshPhongMaterial};
THREE.SEA3D.prototype.readMaterial=function(a){var b=this.createMaterial(a);b.name=a.name;b.side=a.bothSides?THREE.DoubleSide:THREE.FrontSide;b.shading=a.smooth?THREE.SmoothShading:THREE.FlatShading;if("normal"!=a.blendMode)switch(a.blendMode){case "add":b.blending=THREE.AdditiveBlending;break;case "subtract":b.blending=THREE.SubtractiveBlending;break;case "multiply":b.blending=THREE.MultiplyBlending;break;case "screen":b.blending=THREE.CustomBlending,this.material.blendSrc=THREE.OneFactor,this.material.blendDst=
THREE.OneMinusSrcColorFactor,this.material.blendEquation=THREE.AddEquation}for(var c=0;c<a.technique.length;c++){var d=a.technique[c];this.materialTechnique[d.kind]&&this.materialTechnique[d.kind].call(this,b,d,a)}this.materialTechnique.onComplete&&this.materialTechnique.onComplete.call(this,b,a);this.domain.materials=this.materials=this.materials||[];this.materials.push(this.objects["mat/"+a.name]=a.tag=b)};
...
THREE.SEA3D.prototype.readAmbientLight=function(a){var b=new THREE.AmbientLight(this.scaleColor(a.color,a.multiplier*this.config.multiplier));b.name=a.name;this.domain.lights=this.lights=this.lights||[];this.lights.push(this.objects["lht/"+a.name]=a.tag=b);this.addSceneObject(a);this.applyDefaultAnimation(a,THREE.SEA3D.LightAnimator);this.updateScene()};
...
THREE.SEA3D.prototype.getSkeletonAnimation=function(a,b){if(a.tag)return a.tag;for(var c=[],d=1E3/a.frameRate/1E3,e=0;e<a.sequence.length;e++){for(var f=a.sequence[e],h=f.start,g=h+f.count,k={name:f.name,fps:a.frameRate,length:d*f.count,hierarchy:[]},l=a.numJoints,m=a.raw,s=0;s<l;s++){for(var p={parent:b.joint[s].parentIndex,keys:[]},q=p.keys,t=0,r=h;r<g;r++){var n=r*l*7+7*s;q.push({time:t,pos:[m[n],m[n+1],m[n+2]],rot:[m[n+3],m[n+4],m[n+5],m[n+6]],scl:[1,1,1]});t+=d}k.hierarchy[s]=p}h=THREE.AnimationClip.parseAnimation(k,
...
b)}.bind(this);this.file.onParseProgress=b||this.onParseProgress;for(var c=THREE.SEA3D.EXTENSIONS_LOADER.length;c--;){var d=THREE.SEA3D.EXTENSIONS_LOADER[c];d.parse&&d.parse.call(this)}this.file.parse();return this.domain};THREE.SEA3D.prototype.load=function(a){this.loadBytes();this.file.load(a)};THREE.SEA3D.prototype.onHead=function(a){if("TJS"!=a.sign)throw Error("Sign '"+a.sign+"' not supported! Use SEA3D Studio to publish or SEA3DLegacy.js");};THREE.SEA3D.EXTENSIONS_LOADER=[];
THREE.SEA3D.EXTENSIONS_DOMAIN=[];
THREE.SEA3D.prototype.setTypeRead=function(){this.file.typeRead={};this.file.typeRead[SEA3D.Geometry.prototype.type]=this.file.typeRead[SEA3D.GeometryDelta.prototype.type]=this.readGeometryBuffer;this.file.typeRead[SEA3D.Mesh.prototype.type]=this.readMesh;this.file.typeRead[SEA3D.Sprite.prototype.type]=this.readSprite;this.file.typeRead[SEA3D.Container3D.prototype.type]=this.readContainer3D;this.file.typeRead[SEA3D.Line.prototype.type]=this.readLine;this.file.typeRead[SEA3D.Material.prototype.type]=this.readMaterial;
this.file.typeRead[SEA3D.Camera.prototype.type]=this.readCamera;this.file.typeRead[SEA3D.SkeletonLocal.prototype.type]=this.readSkeletonLocal;this.file.typeRead[SEA3D.JointObject.prototype.type]=this.readJointObject;this.file.typeRead[SEA3D.CubeMap.prototype.type]=this.readCubeMap;this.file.typeRead[SEA3D.CubeRender.prototype.type]=this.readCubeRender;this.file.typeRead[SEA3D.Animation.prototype.type]=this.readAnimation;this.file.typeRead[SEA3D.SoundPoint.prototype.type]=this.readSoundPoint;this.file.typeRead[SEA3D.TextureURL.prototype.type]=
...
THREE.SEA3D.prototype.updateAnimationSet=function(a){var b=new THREE.Matrix4,c=new THREE.Matrix4,d=new THREE.Vector3,e=new THREE.Quaternion,f=new THREE.Vector3,h=new THREE.Vector3,g=new THREE.Quaternion,k=new THREE.Vector3;return function(a){var m=a.animation.animationSet,s=m.animations;if(!m.flip||s.length){for(var p=s[0].dataList,s=[],q=0;q<p.length;q++){var t=p[q],r=p[q].data,n=t.kind,t=r.length/t.blockLength;switch(n){case SEA3D.Animation.POSITION:case SEA3D.Animation.ROTATION:case SEA3D.Animation.SCALE:s.push({kind:n,
numFrames:t,raw:r})}}if(0<s.length)for(t=s[0].numFrames,r=void 0,a.animation.relative?(b.identity(),this.flipMatrixScale(c.copy(a.matrixWorld))):(a.parent&&(r=this.flipMatrixScale(c.copy(a.parent.matrixWorld))),this.flipMatrixScale(b.copy(a.matrix),!1,r)),b.decompose(d,e,f),a=0;a<t;a++){for(p=0;p<s.length;p++)switch(r=s[p].raw,n=s[p].kind,n){case SEA3D.Animation.POSITION:n=3*a;d.set(r[n],r[n+1],r[n+2]);break;case SEA3D.Animation.ROTATION:n=4*a;e.set(r[n],r[n+1],r[n+2],r[n+3]);break;case SEA3D.Animation.SCALE:n=
4*a,f.set(r[n],r[n+1],r[n+2])}b.compose(d,e,f);this.flipMatrixScale(b,!1,c);b.decompose(h,g,k);for(p=0;p<s.length;p++)switch(r=s[p].raw,n=s[p].kind,n){case SEA3D.Animation.POSITION:n=3*a;r[n]=h.x;r[n+1]=h.y;r[n+2]=h.z;break;case SEA3D.Animation.ROTATION:n=4*a;r[n]=g.x;r[n+1]=g.y;r[n+2]=g.z;r[n+3]=g.w;break;case SEA3D.Animation.SCALE:n=3*a,r[n]=k.x,r[n+1]=k.y,r[n+2]=k.z}}m.flip=!0}}}();
...
THREE.SEA3D.prototype.readSkeleton=function(a){var b=new THREE.Matrix4,c=new THREE.Matrix4,d=new THREE.Matrix4,e=new THREE.Vector3,f=new THREE.Quaternion;return function(a){for(var g=[],k=a.sea3d.config.legacy,l=0;l<a.joint.length;l++){var m=a.joint[l];b.elements=m.inverseBindMatrix;c.getInverse(b);k&&this.flipMatrixBone(c);-1<m.parentIndex&&(b.elements=a.joint[m.parentIndex].inverseBindMatrix,d.getInverse(b),k&&this.flipMatrixBone(d),d.getInverse(d),c.multiplyMatrices(d,c));e.setFromMatrixPosition(c);
f.setFromRotationMatrix(c);g[l]={name:m.name,pos:[e.x,e.y,e.z],rotq:[f.x,f.y,f.z,f.w],parent:m.parentIndex}}return a.tag=g}}();THREE.SEA3D.prototype.getSkeletonAnimation=function(a,b){return this.isLegacy(a)?this.getSkeletonAnimationLegacy(a,b):this._getSkeletonAnimation(a,b)};
THREE.SEA3D.prototype.getSkeletonAnimationLegacy=function(a,b){var c=new THREE.Matrix4,d=new THREE.Matrix4,e=new THREE.Matrix4,f=new THREE.Matrix4;return function(a,b){if(a.tag)return a.tag;for(var k=[],l=1E3/a.frameRate/1E3,m=[1,1,1],s=0;s<a.sequence.length;s++){for(var p=a.sequence[s],q=p.start,t=q+p.count,r={name:p.name,repeat:p.repeat,fps:a.frameRate,JIT:0,length:l*p.count,hierarchy:[]},n=a.numJoints,v=a.raw,w=0;w<n;w++){for(var y=b.joint[w],B={parent:y.parentIndex,keys:[]},C=B.keys,z=0,A=q;A<
t;A++){var u=A*n*7+7*w;d.makeRotationFromQuaternion(THREE.SEA3D.QUABUF.set(v[u+3],v[u+4],v[u+5],v[u+6]));d.setPosition(THREE.SEA3D.VECBUF.set(v[u],v[u+1],v[u+2]));-1<y.parentIndex?(c.elements=b.joint[y.parentIndex].inverseBindMatrix,f.getInverse(c),e.multiplyMatrices(f,d),this.flipMatrixBone(e),this.flipMatrixBone(f),f.getInverse(f),d.multiplyMatrices(f,e)):this.flipMatrixBone(d);var u=THREE.SEA3D.VECBUF.setFromMatrixPosition(d),x=THREE.SEA3D.QUABUF.setFromRotationMatrix(d);C.push({time:z,pos:[u.x,
u.y,u.z],rot:[x.x,x.y,x.z,x.w],scl:m});z+=l}r.hierarchy[w]=B}q=THREE.AnimationClip.parseAnimation(r,b.tag);q.loop=p.repeat;q.timeScale=1;k.push(q)}return a.tag=k}}();THREE.SEA3D.prototype.readVertexAnimation=function(a){if(this.isLegacy(a))for(var b=0,c=a.frame.length;b<c;b++){var d=a.frame[b];this.flipZVec3(d.vertex);this.flipZVec3(d.normal)}this._readVertexAnimation(a)};
...
THREE.SEA3D.EXTENSIONS_LOADER.push({setTypeRead:function(){this.config.legacy=void 0==this.config.legacy?!0:this.config.legacy;this.file.typeRead[SEA3D.Skeleton.prototype.type]=this.readSkeleton}});SEA3D.AnimationBlendMethod={LINEAR:"linear",EASING:"easing"};SEA3D.AnimationFrame=function(){this.data=[0,0,0,0]};SEA3D.AnimationFrame.prototype.toVector=function(){return{x:this.data[0],y:this.data[1],z:this.data[2],w:this.data[3]}};SEA3D.AnimationFrame.prototype.toAngles=function(a){var b=this.data[0],c=this.data[1],d=this.data[2],e=this.data[3],f=2*(e*c-d*b);-1>f?f=-1:1<f&&(f=1);return{x:Math.atan2(2*(e*b+c*d),1-2*(b*b+c*c))*a,y:Math.asin(f)*a,z:Math.atan2(2*(e*d+b*c),1-2*(c*c+d*d))*a}};
SEA3D.AnimationFrame.prototype.toEuler=function(){return this.toAngles(SEA3D.Math.DEGREES)};SEA3D.AnimationFrame.prototype.toRadians=function(){return this.toAngles(1)};SEA3D.AnimationFrame.prototype.setX=function(a){this.data[0]=a};SEA3D.AnimationFrame.prototype.getX=function(){return this.data[0]};SEA3D.AnimationFrame.prototype.setY=function(a){this.data[1]=a};SEA3D.AnimationFrame.prototype.getY=function(){return this.data[1]};SEA3D.AnimationFrame.prototype.setZ=function(a){this.data[2]=a};
SEA3D.AnimationFrame.prototype.getZ=function(){return this.data[2]};SEA3D.AnimationFrame.prototype.setW=function(a){this.data[3]=a};SEA3D.AnimationFrame.prototype.getW=function(){return this.data[3]};
SEA3D.AnimationData=function(a,b,c,d){this.kind=a;this.type=b;this.blockLength=SEA3D.Stream.sizeOf(b);this.data=c;this.offset=void 0==d?0:d;switch(this.blockLength){case 1:this.getData=this.getData1x;break;case 2:this.getData=this.getData2x;break;case 3:this.getData=this.getData3x;break;case 4:this.getData=this.getData4x}};SEA3D.AnimationData.prototype.getData1x=function(a,b){a=this.offset+a*this.blockLength;b[0]=this.data[a]};
SEA3D.AnimationData.prototype.getData2x=function(a,b){a=this.offset+a*this.blockLength;b[0]=this.data[a];b[1]=this.data[a+1]};SEA3D.AnimationData.prototype.getData3x=function(a,b){a=this.offset+a*this.blockLength;b[0]=this.data[a];b[1]=this.data[a+1];b[2]=this.data[a+2]};SEA3D.AnimationData.prototype.getData4x=function(a,b){a=this.offset+a*this.blockLength;b[0]=this.data[a];b[1]=this.data[a+1];b[2]=this.data[a+2];b[3]=this.data[a+3]};
...
SEA3D.AnimationHandler.prototype.updateAnimation=function(){for(var a=this.animationSet.dataCount,b=this.animationSet.animations,c=this.currentState.node,d=0;d<a;d++)for(var e=0;e<b.length;e++){var f=b[e],h=this.states[e],g=f.dataList[d],k=SEA3D.Animation.DefaultLerpFuncs[g.kind],l;if(0==e&&(l=c.getInterpolationFrame(c.dataList[d],k),!c.repeat&&c.frame==c.numFrames-1&&this.onComplete))this.onComplete(this);f!=c&&0<h.weight&&k(l.data,f.getInterpolationFrame(g,k).data,h.weight);this.updateAnimationFrame&&
this.updateAnimationFrame(l,g.kind)}};SEA3D.AnimationHandler.prototype.getStateByName=function(a){return this.states[a]};SEA3D.AnimationHandler.prototype.getStateNameByIndex=function(a){return this.animationSet.animations[a].name};
...
SEA3D.AnimationHandler.setTime=function(a){for(var b=0,c=SEA3D.AnimationHandler.animations.length;b<c;b++)SEA3D.AnimationHandler.animations[b].time=a};SEA3D.AnimationHandler.stop=function(){for(;SEA3D.AnimationHandler.animations.length;)SEA3D.AnimationHandler.animations[0].stop()};SEA3D.AnimationHandler.animations=[];
