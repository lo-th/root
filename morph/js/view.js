...
var view = ( function () {
    ...
    view = {
        ...
        init: function () {
            ...
            renderer.setSize( vsize.x, vsize.y );
            renderer.setClearColor( 0x2c2c26 );
            ...
            var pointLight = new THREE.PointLight( 0xddddff, 0.2 );
            scene.add( pointLight );

            pointLight.position.set( -5,-10,-6 );
        ...
        addBasicGround: function ( x, y ) {
            ...
            var plane = new THREE.Mesh( g, new THREE.MeshLambertMaterial({ color:0x080807, transparent:true, opacity:1, depthWrite:false }) );
