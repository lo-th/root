...
c=this.source.add(c.mult(b));return new TRAFFIC.Segment(d,c)}};TRAFFIC.World=function(a){this.debug=a;this.toRemove=[];this.onTick=TRAFFIC.bind(this.onTick,this);this.set({});Object.defineProperty(this,"instantSpeed",{get:function(){var a;a=TRAFFIC.map(this.cars.all(),function(a){return a.speed});return 0===a.length?0:TRAFFIC.reduce(a,function(a,b){return a+b})/a.length}})};
