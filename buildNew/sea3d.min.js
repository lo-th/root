...
SEA3D.Script={DETAILED:!1,readScriptList:function(a,b){for(var c=[],d=a.readUByte(),e=0;e<d;){var f=a.readUByte(),g={};g.priority=f&1|f&2;if(f&4){var h,k,d=a.readUByte();if(SEA3D.Script.DETAILED)for(g.params=[],h=0;h<d;h++){k=a.readUTF8();var l=a.readUByte();g.params[h]={name:k,type:l,data:SEA3D.DataTable.readToken(l,a)}}else for(g.params={},h=0;h<d;h++)k=a.readUTF8(),g.params[k]=SEA3D.DataTable.readObject(a)}f&8&&(g.method=a.readUTF8());g.tag=b.getObject(a.readUInt());c[e++]=g}return c}};
...
THREE.SEA3D.prototype.readGeometryBuffer=function(a){var b=a.indexes[0],c=b.length,d=new THREE.BufferGeometry,e,f,g,h,k;d.attributes={index:{itemSize:1,array:e=new Uint16Array(c)},position:{itemSize:3,array:f=new Float32Array(3*c)},uv:{itemSize:2,array:h=new Float32Array(2*c)}};var l,n,p,s=a.vertex,t=a.normal,v=a.uv?a.uv[0]:void 0,q=a.color?a.color[0]:void 0;t&&(d.attributes.normal={itemSize:3,array:g=new Float32Array(3*c)});q&&(d.attributes.color={itemSize:3,array:k=new Float32Array(3*c)});for(var r=
0,m=0,u=0;r<c;r+=3,m+=9,u+=6)l=3*b[r],n=3*b[r+2],p=3*b[r+1],f[m]=s[l],f[m+1]=s[l+1],f[m+2]=s[l+2],f[m+3]=s[n],f[m+4]=s[n+1],f[m+5]=s[n+2],f[m+6]=s[p],f[m+7]=s[p+1],f[m+8]=s[p+2],t&&(g[m]=t[l],g[m+1]=t[l+1],g[m+2]=t[l+2],g[m+3]=t[n],g[m+4]=t[n+1],g[m+5]=t[n+2],g[m+6]=t[p],g[m+7]=t[p+1],g[m+8]=t[p+2]),v?(l=2*b[r],n=2*b[r+2],p=2*b[r+1],h[u]=v[l],h[u+1]=v[l+1],h[u+2]=v[n],h[u+3]=v[n+1],h[u+4]=v[p],h[u+5]=v[p+1]):(h[u]=0,h[u+1]=0,h[u+2]=0,h[u+3]=1,h[u+4]=1,h[u+5]=1),q&&(l=4*b[r],n=4*b[r+2],p=4*b[r+1],
k[m]=q[l],k[m+1]=q[l+1],k[m+2]=q[l+2],k[m+3]=q[n],k[m+4]=q[n+1],k[m+5]=q[n+2],k[m+6]=q[p],k[m+7]=q[p+1],k[m+8]=q[p+2]),e[r]=r,e[r+1]=r+1,e[r+2]=r+2;t||d.computeVertexNormals();this.tangent&&!a.tangent&&d.computeTangents();this.bounding&&(d.computeBoundingBox(),d.computeBoundingSphere());d.name=a.name;a.tag=d};
THREE.SEA3D.prototype.readGeometry=function(a){var b,c,d,e=new THREE.Geometry,f,g,h;e.vertices=this.flipZ?this.vectorToVector3Inv(a.vertex):this.vectorToVector3(a.vertex);a.normal&&(f=this.flipZ?this.vectorToVector3Inv(a.normal):this.vectorToVector3(a.normal));a.color&&(g=this.vectorToColor(a.color[0]));if(a.uv)for(h=this.vectorToUV(a.uv),d=0;d<h.length;d++)e.faceVertexUvs[d]=[];for(b=0;b<a.indexes.length;b++){var k=a.indexes[b],l=k.length/3;for(c=0;c<l;c++){d=3*c;var n,p,s;n=k[d];s=k[d+1];p=k[d+
2];d=new THREE.Face3(n,p,s,f?[f[n],f[p],f[s]]:void 0,g?[g[n],g[p],g[s]]:void 0,b);e.faces.push(d);if(h)for(d=0;d<h.length;d++)e.faceVertexUvs[d].push([h[d][n],h[d][p],h[d][s]]);else e.faceVertexUvs[0].push([new THREE.Vector2(0,0),new THREE.Vector2(0,1),new THREE.Vector2(1,1)])}}if(a.joint)if(f=[0,0,0,0],g=[0,0,0,0],h=a.jointPerVertex,4<h)for(d=0;d<a.joint.length;d+=h){k=[0];for(c=1;c<h;c++)l=a.weight[d+c],l>a.weight[d+k[0]]?k.unshift(c):k.push(c);l=(1-(a.weight[d+k[0]]+a.weight[d+k[1]]+a.weight[d+
k[2]]+a.weight[d+k[3]]))/4;for(c=0;4>c;c++)b=k[c],f[c]=a.joint[d+b],g[c]=a.weight[d+b]+l;e.skinIndices.push(new THREE.Vector4(f[0],f[1],f[2],f[3]));e.skinWeights.push(new THREE.Vector4(g[0],g[1],g[2],g[3]))}else for(d=0;d<a.joint.length;d+=h){for(c=0;c<h;c++)f[c]=a.joint[d+c],g[c]=a.weight[d+c];e.skinIndices.push(new THREE.Vector4(f[0],f[1],f[2],f[3]));e.skinWeights.push(new THREE.Vector4(g[0],g[1],g[2],g[3]))}a.normal||(e.computeFaceNormals(),e.computeVertexNormals());this.tangent&&!a.tangent&&e.computeTangents();
