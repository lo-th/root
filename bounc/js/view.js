...
var view = ( function () {
    ...
    var renderer, scene, camera, controls, canvas, vsize, composer, pass, copyPass, light;
    ...
    view.init = function () {
       ...
       // scene = new THREE.Scene();
       //scene.fog = new THREE.Fog( 0xc60e13, 1000, 2000 );
    ...
    view.addGround = function(){
        ...
        var grd0 = ctx.createLinearGradient(0,0,0,128);
        grd0.addColorStop(0,"rgba(255,255,255,0)");
        grd0.addColorStop(1,"rgba(255,255,255,0.4)");
        ...
        texture.repeat.set( 21, 1 );

        texture.needsUpdate = true;

        var geo = new THREE.PlaneBufferGeometry( 1000, 1000 );
        geo.applyMatrix( new THREE.Matrix4().makeRotationX( - Math.PI * 0.5 ));
        var mat = new THREE.MeshLambertMaterial({ map:texture, transparent: true, emissive:0x666666, blending:THREE.AdditiveBlending });//
        //var mat = new THREE.MeshLambertMaterial({ });//
        //var mat = new THREE.MeshLambertMaterial( { color: 0xFFFFFF, transparent: true, blending:THREE.MultiplyBlending } );
    ...
    view.setExtraUpdate = function( extra ){
        extraUpdate = extra;
    };
    ...
    view.initLight = function( shadow ){
        ...
        // top sky
        var pointLight = new THREE.PointLight( 0x70b4db, 0.8, 1000 );
        pointLight.position.set(-100, 300, -300)
        scene.add( pointLight );

        // green Floor
        var pointLight2 = new THREE.PointLight( 0x136321, 0.5, 1000 );
        pointLight2.position.set(100, -200, -100)
        scene.add( pointLight2 );

        // hot red
        var pointLight3 = new THREE.PointLight( 0xda450d, 0.7, 1000 );
