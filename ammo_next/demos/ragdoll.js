function demo() {
    ...
    while(j--){
        n = (j*3)*0.1;
        phy.add({ type:'box', size:[8,0.3,1], pos:[0,0.15+n,3-n*1.2], material:'sleep' });
    }
...
function ragdoll( o ){
    ...
    for( let n in data ){
        b[ n ] = phy.add({ type:'capsule', density:1, restitution:0.2, friction:0.5, size:data[n].size, pos:math.addArray( o.pos, data[n].pos ), rot:data[n].rot||[0,0,0], material:'skin' })
    }
